...
const Core::ParameterBool ExpandingFsaSearch::paramInitialEpsilonPruning_(
        ...
        "useful for networks with large amounts of epsilon arcs and long epsilon paths", false);
...
const Core::ParameterBool ExpandingFsaSearch::paramIgnoreLastOutput(
        ...
        "required if C's sequence end symbol != epsilon and disambiguators are not exploited", false);
