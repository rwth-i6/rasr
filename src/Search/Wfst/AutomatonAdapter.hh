...
public:
    ...
    AutomatonAdapter(const Automaton *f) : f_(f), nArcs_(0), nEpsArcs_(0) {}
    ...
    u32 nStates() const;
    u32 nArcs() const { if (!nArcs_) countArcs(); return nArcs_; }
    u32 nEpsilonArcs() const { if (!nArcs_) countArcs(); return nEpsArcs_; }
...
// template<>
// const Fsa::LabelId AutomatonAdapter<Fsa::StaticAutomaton, Fsa::Arc, Fsa::StateId, Fsa::LabelId>::Epsilon = Fsa::Epsilon;
...
//template<>
//const OpenFst::Label AutomatonAdapter<OpenFst::VectorFst, OpenFst::Arc, OpenFst::StateId, OpenFst::Label>::Epsilon = OpenFst::Epsilon;
