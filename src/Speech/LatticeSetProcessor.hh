 ...
 */
class LatticeSetProcessor : virtual public Core::Component,
...
public:
    ...
    virtual void signOn(CorpusVisitor& corpusVisitor) {
        if (processor_)
            processor_->signOn(corpusVisitor);
    }
    ...
    virtual void enterRecording(Bliss::Recording* recording) {
        if (processor_)
            processor_->enterRecording(recording);
    }
    ...
    virtual void leaveRecording(Bliss::Recording* recording) {
        if (processor_)
            processor_->leaveRecording(recording);
    }
    ...
    virtual void enterSpeechSegment(Bliss::SpeechSegment* s) {
        if (processor_)
            processor_->enterSpeechSegment(s);
    }
    ...
    virtual void leaveSpeechSegment(Bliss::SpeechSegment* s) {
        if (processor_)
            processor_->leaveSpeechSegment(s);
    }
 ...
 */
class LatticeSetProcessorRoot : public CorpusProcessor,
 ...
 * Cache node
 */
class CacheNode : public LatticeSetProcessor {
    typedef LatticeSetProcessor Precursor;
 ...
 * Copy node
 */
class CopyNode : public LatticeSetProcessor {
    typedef LatticeSetProcessor Precursor;
 ...
 * Partial node
 */
class PartialNode : public LatticeSetProcessor {
    typedef LatticeSetProcessor     Precursor;
 ...
 * Empty node
 */
class SkipEmptyLatticeNode : public LatticeSetProcessor {
    typedef LatticeSetProcessor Precursor;
