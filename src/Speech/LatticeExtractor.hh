...
protected:
    static const Core::ParameterFloat paramFallBackValue;
...
public:
    ...
    static LatticeRescorer* createDistanceLatticeRescorer(const Core::Configuration&, Bliss::LexiconRef);
};
 ...
 */
class ArchiveApproximateWordAccuracyLatticeRescorer : public ApproximateDistanceLatticeRescorer {
...
class OrthographyApproximateWordAccuracyLatticeRescorer : public ApproximateDistanceLatticeRescorer {
    typedef ApproximateDistanceLatticeRescorer Precursor;
 ...
 */
class ApproximatePhoneAccuracyLatticeRescorer : public ApproximateDistanceLatticeRescorer {
    typedef ApproximateDistanceLatticeRescorer           Precursor;
    typedef Core::Ref<PhonemeSequenceAlignmentGenerator> AlignmentGeneratorRef;
...
class ArchiveApproximatePhoneAccuracyLatticeRescorer : public ApproximatePhoneAccuracyLatticeRescorer {
...
class OrthographyApproximatePhoneAccuracyLatticeRescorer : public ApproximatePhoneAccuracyLatticeRescorer {
    typedef ApproximatePhoneAccuracyLatticeRescorer Precursor;
