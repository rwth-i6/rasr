...
SegmentOrderingVisitor::SegmentOrderingVisitor() :
    visitor_(0), curSegment_(0), curRecording_(0),
    shortNameLookup_(false), autoShuffle_(false),
    sortByTimeLength_(false), sortByTimeLengthChunkSize_(0),
...
SegmentOrderingVisitor::CustomCorpusGuide::CustomCorpusGuide(SegmentOrderingVisitor* parent, Corpus* rootCorpus)
    : parent_(parent), rootCorpus_(rootCorpus),
      curCorpus_(rootCorpus_), curRecording_(0)
{
