...
link_libraries(LibXml2::LibXml2 ZLIB::ZLIB Threads::Threads LAPACK::LAPACK
               ${LIB_RT})
...
if(${MODULE_AUDIO_FFMPEG})
  ...
  include_directories(${AVFORMAT_INCLUDE_DIRS} ${SWRESAMPLE_INCLUDE_DIRS}
                      ${AVCODEC_INCLUDE_DIRS} ${AVUTIL_INCLUDE_DIRS})
  link_libraries(PkgConfig::AVFORMAT PkgConfig::SWRESAMPLE PkgConfig::AVCODEC
                 PkgConfig::AVUTIL)
endif()
...
if(${MODULE_CUDA})
  ...
  set(CMAKE_CUDA_ARCHITECTURES 61;75;86;87;89;90;100;120)
endif()
