...
class ContextPhonology : public Phonology,
...
public:
    ...
    public:
        ...
        SemiContext(size_t s, Phoneme::Id p = Phoneme::term)
                : Precursor(s, p) {}
        SemiContext(const SemiContext& o)
                : Precursor(o) {}

        bool empty() const;

        struct Hash {
            u32 operator()(const SemiContext& sc) const;
        };
    };
    struct Context {
...
public:
    ...
    PhonemeInventoryRef getPhonemeInventory() const {
        return pi_;
    }
    s32 maximumHistoryLength() const {
        return maximumHistoryLength_;
    }
    s32 maximumFutureLength() const {
        return maximumFutureLength_;
    }
...
class ContextPhonology::PhonemeInContext : public Bliss::Allophone {
private:
