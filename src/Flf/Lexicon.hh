...
public:
    ...
    public:
        ...
        std::string symbol(Fsa::LabelId label) const {
            return alphabet_->symbol(label);
        }
        Fsa::LabelId index(const std::string& symbol) const {
            return (lexicon_->*index_)(symbol);
        }
    ...
    public:
        ...
        virtual ~AlphabetMap() {}
        Fsa::ConstAlphabetRef from() const {
            return from_;
        }
        Fsa::ConstAlphabetRef to() const {
            return to_;
        }
...
private:
    ...
    typedef std::unordered_map<std::string, Bliss::Lemma*, Core::StringHash, Core::StringEquality> LemmaMap;
...
public:
    ...
    u32 nLemmaUpdates() const {
        return nLemmaUpdates_;
    }

    /*
     * Lexicon entries
     */
    Fsa::LabelId siLemmaId() {
        return siLemmaId_;
    }
    Fsa::LabelId siLemmaPronunciationId() {
        return siLemmaPronunciationId_;
    }
    Fsa::LabelId unkLemmaId() {
        return unkLemmaId_;
    }
    Fsa::LabelId unkLemmaPronunciationId() {
        return unkLemmaPronunciationId_;
    }
    Fsa::LabelId sentenceEndLemmaId() {
        return sentenceEndLemmaId_;
    }
    Fsa::LabelId sentenceEndLemmaPronunciationId() {
        return sentenceEndLemmaPronunciationId_;
    }
     ...
     * Alphabets
     */
    Fsa::ConstAlphabetRef unknownAlphabet() const {
        return unknownAlphabet_;
    }
