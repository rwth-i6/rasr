...
namespace Flf {
        ...
        /*
          TODO:
          - Results from CN building algorithms are evetually arc clusters aka sausages
          - Define interface for sausages and pull out the three algorithms: getMapping, getCn, getNormalizedCn
        */
        class Sausage {
        public:
                class Slot {
                public:
                        class Arc {
                        public:
                                virtual Fsa::StateId stateId() const = 0;
                                virtual Fsa::StateId arcId() const = 0;
                                virtual Time start() const = 0;
                                virtual Time end() const = 0;
                                virtual ScoresRef scores() const = 0;
                                virtual Score posteriorScore() const = 0;

                        };
                        class const_iterator {
                        public:
                                virtual const Arc& operator*() const = 0;
