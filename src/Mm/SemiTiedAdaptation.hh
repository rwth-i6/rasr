...
namespace Mm {
    ...
    public:
        ...
        virtual Sum minAdaptationObservations() {return minSemiTiedAdaptationObservations_;}

        // virtual AdaptorEstimator* clone() const;
        virtual std::string typeName() const { return "semi-tied-estimator"; }
    ...
    class  SemiTiedOptimizationGradient:
        public Math::Nr::GradientBase<Math::Vector<double>, Math::Vector<double> >
    {
    private:
        ComponentIndex dimension_;
        const Math::Vector<Matrix> &G_,&Z_;
