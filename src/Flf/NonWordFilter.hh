...
namespace Flf {
    ...
    /**
     * Filters the lattice by removing redundant paths which represent word sequences
     * for which a better scoring path is available in the lattice.
     * */
    StaticLatticeRef uniqueSentenceAlignmentFilter(ConstLatticeRef l, u32 maxWidth = 100000, u32 maxDepth = 10, int maxClosureLength=1000);
