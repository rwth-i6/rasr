...
public:
    void apply(Vector<T>& v, T) {
        std::transform(v.begin(), v.end(), v.begin(), static_cast<T (*)(T)>(std::log10));
    }
    static std::string name() {
        return Vector<T>::type()->name() + "-log";
    }
};
...
public:
    void apply(DataAdaptor<T>& v, T) {
        v() = log10(v());
    }
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-log";
    }
};
...
public:
    void apply(Vector<T>& v, T parameter) {
        for (u32 i = 0; i < v.size(); i++)
            v[i] = log10(v[i] + parameter);
    };
    static std::string name() {
        return Vector<T>::type()->name() + "-log-plus";
    }
};
...
public:
    void apply(DataAdaptor<T>& v, T parameter) {
        v() = log10(v() + parameter);
    };
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-log-plus";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-ln-save";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-ln";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-exp";
    }
};
...
public:
    void apply(Vector<T>& v, T parameter) {
        for (u32 i = 0; i < v.size(); i++)
            v[i] = pow(v[i], parameter);
    };
    static std::string name() {
        return Vector<T>::type()->name() + "-power";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-power";
    }
};
...
public:
    void apply(Vector<T>& v, T) {
        std::transform(v.begin(), v.end(), v.begin(), static_cast<T (*)(T)>(std::sqrt));
    }
    static std::string name() {
        return Vector<T>::type()->name() + "-sqrt";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-sqrt";
    }
};
...
public:
    void apply(Vector<T>& v, T) {
        std::transform(v.begin(), v.end(), v.begin(), static_cast<T (*)(T)>(std::cos));
    }
    static std::string name() {
        return Vector<T>::type()->name() + "-cos";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-cos";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-addition";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-addition";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-multiplication";
    }
};
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-multiplication";
    }
};
...
public:
    static std::string name() {
        return Vector<T>::type()->name() + "-quantize";
    }
    void apply(Vector<T>& v, T parameter) {
...
public:
    ...
    static std::string name() {
        return DataAdaptor<T>::type()->name() + "-abs";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-adjacent-difference";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-linear";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-sigmoid";
    }
};
...
public:
    ...
    static std::string name() {
        return Vector<T>::type()->name() + "-softmax";
    }
};
...
public:
    void apply(Vector<T>& v, T) {
        /* v[i] = tanh( v[i] )*/
        std::transform(v.begin(), v.end(), v.begin(), static_cast<T (*)(T)>(std::tanh));
    }

    static std::string name() {
        return Vector<T>::type()->name() + "-tanh";
    }
};
