...
private:
    static xmlParserInputPtr SAX_resolveEntity_callback(void* ctx, const xmlChar* publicId, const xmlChar* systemId);
    static void              SAX_internalSubset_callback(void* ctx, const xmlChar* name, const xmlChar* ExternalID, const xmlChar* SystemID);
    static void              SAX_externalSubset_callback(void* ctx, const xmlChar* name, const xmlChar* ExternalID, const xmlChar* SystemID);
    static xmlEntityPtr      SAX_getEntity_callback(void* ctx, const xmlChar* name);
    static xmlEntityPtr      SAX_getParameterEntity_callback(void* ctx, const xmlChar* name);
    static void              SAX_entityDecl_callback(void* ctx, const xmlChar* name, int type, const xmlChar* publicId, const xmlChar* systemId, xmlChar* content);
    static void              SAX_notationDecl_callback(void* ctx, const xmlChar* name, const xmlChar* publicId, const xmlChar* systemId);
    static void              SAX_attributeDecl_callback(void* ctx, const xmlChar* elem, const xmlChar* name, int type, int def, const xmlChar* defaultValue, xmlEnumerationPtr tree);
    static void              SAX_elementDecl_callback(void* ctx, const xmlChar* name, int type, xmlElementContentPtr content);
    static void              SAX_unparsedEntityDecl_callback(void* ctx, const xmlChar* name, const xmlChar* publicId, const xmlChar* systemId, const xmlChar* notationName);
    static void              SAX_startDocument_callback(void* ctx);
    static void              SAX_endDocument_callback(void* ctx);
    static void              SAX_startElement_callback(void* ctx, const xmlChar* name, const xmlChar** atts);
    static void              SAX_endElement_callback(void* ctx, const xmlChar* name);
    static void              SAX_reference_callback(void* ctx, const xmlChar* name);
    static void              SAX_characters_callback(void* ctx, const xmlChar* ch, int len);
    static void              SAX_cdataBlock_callback(void* ctx, const xmlChar* ch, int len);
    static void              SAX_ignorableWhitespace_callback(void* ctx, const xmlChar* ch, int len);
    static void              SAX_processingInstruction_callback(void* ctx, const xmlChar* target, const xmlChar* data);
    static void              SAX_comment_callback(void* ctx, const xmlChar* value);
    static void              SAX_warning_callback(void* ctx, const char* msg, ...) __attribute__((format(printf, 2, 3)));
    static void              SAX_error_callback(void* ctx, const char* msg, ...) __attribute__((format(printf, 2, 3)));
    static void              SAX_fatalError_callback(void* ctx, const char* msg, ...) __attribute__((format(printf, 2, 3)));
...
protected:
    ...
    virtual xmlParserInputPtr resolveEntity(const char* publicId, const char* systemId);
    virtual void              internalSubset(const char* name, const char* ExternalID, const char* SystemID);
    virtual void              externalSubset(const char* name, const char* ExternalID, const char* SystemID);
    virtual xmlEntityPtr      getEntity(const char* name);
    virtual xmlEntityPtr      getParameterEntity(const char* name);
    virtual void              entityDecl(const char* name, int type, const char* publicId, const char* systemId, const char* content);
    virtual void              notationDecl(const char* name, const char* publicId, const char* systemId);
    virtual void              attributeDecl(const char* elem, const char* name, int type, int def, const char* defaultValue, xmlEnumerationPtr tree);
    virtual void              elementDecl(const char* name, int type, xmlElementContentPtr content);
    virtual void              unparsedEntityDecl(const char* name, const char* publicId, const char* systemId, const char* notationName);
...
public:
    ...
    XmlElement* add(XmlElement* e) {
        xmlElements_.push_back(e);
        return e;
    }
};
...
class XmlElement : public XmlContext {
public:
...
protected:
     ...
     */
    XmlElement* collect(XmlElement* child) {
        return garbageCollector_.add(child);
    }
...
public:
    ...
    XmlEmptyElement(const char* _name, XmlContext* _context, bool allowWhitespace = true);
};

class XmlEmptyElementRelay : public XmlEmptyElement {
private:
    XmlContext::StartHandler startHandler_;

public:
    virtual void start(const XmlAttributes atts);
    XmlEmptyElementRelay(const char* _name, XmlContext* _context, XmlContext::StartHandler _startHandler = 0);
};
...
class XmlParentElement : public XmlElement {
protected:
...
class XmlIgnoreElement : public XmlElement {
private:
...
class XmlFlattenElement : public XmlElement {
protected:
...
class XmlFlattenElementRelay : public XmlFlattenElement {
private:
    XmlContext::StartHandler startHandler_;
...
public:
    ...
    XmlFlattenElementRelay(const char* _name, XmlContext* _context, XmlContext::StartHandler = 0, XmlContext::EndHandler = 0);
};
...
class XmlDocumentElement : public XmlParentElement {
private:
    XmlElement* root_;
...
class XmlMixedElement : public XmlParentElement {
protected:
...
public:
    ...
    XmlMixedElement(const char* _name, XmlContext* _context, XmlElement* child, ...);
...
class XmlMixedElementRelay : public XmlMixedElement {
private:
    XmlContext::StartHandler      startHandler_;
    XmlContext::EndHandler        endHandler_;
...
public:
    ...
    XmlMixedElementRelay(const char* _name, XmlContext* _context, XmlContext::StartHandler = 0,
                         XmlContext::EndHandler = 0, XmlContext::CharactersHandler = 0);

    XmlMixedElementRelay(const char* _name, XmlContext* _context, XmlContext::StartHandler, XmlContext::EndHandler, XmlContext::CharactersHandler,
                         XmlElement* child, ...);
};
...
class XmlRegularElement : public XmlParentElement {
public:
    typedef int State;
...
class XmlRegularElementRelay : public XmlRegularElement {
...
public:
    ...
    XmlRegularElementRelay(const char* _name, XmlContext* _context, XmlContext::StartHandler = 0, XmlContext::EndHandler = 0);
};
...
class XmlSchemaParser : public XmlParser,
