 ...
 */
#define require(expr) \
    ((expr) ? ((void)0) : AssertionsPrivate::assertionFailed("precondition", __STRING(expr), __PRETTY_FUNCTION__, __FILE__, __LINE__))

// Internal macro used by require_{eq,ne,lt,gt,le,ge,null,notnull}
#define _require_rel(x, y, r, n) \
    (((x)r(y)) ? ((void)0) : AssertionsPrivate::assertionFailedVerbose(x, y, __STRING(r), __STRING(x r y), __PRETTY_FUNCTION__, __FILE__, __LINE__))
...
#define requirec(expr, comment) \
    ((expr) ? ((void)0) : AssertionsPrivate::assertionFailed("precondition", __STRING(expr) __STRING(->) __STRING(comment), __PRETTY_FUNCTION__, __FILE__, __LINE__))
#else
 ...
 */
#define ensure(expr) \
    ((expr) ? ((void)0) : AssertionsPrivate::assertionFailed("postcondition", __STRING(expr), __PRETTY_FUNCTION__, __FILE__, __LINE__))
#else
 ...
 */
#define verify(expr) \
    ((expr) ? ((void)0) : AssertionsPrivate::assertionFailed("assertion", __STRING(expr), __PRETTY_FUNCTION__, __FILE__, __LINE__))
...
#define hope(expr) \
    ((expr) ? (void)0 : AssertionsPrivate::hopeDisappointed(__STRING(expr), __PRETTY_FUNCTION__, __FILE__, __LINE__))
