...
public:
    ...
    virtual bool fullBatchMode() const { return fullBatchMode_ ; }
    virtual void setFullBatchMode(bool fullBatchMode) { fullBatchMode_ = fullBatchMode; }
    // accumulate over multiple batches
    virtual int accumulateMultipleBatches() const { return accumulateMultipleBatches_; }
    virtual T learningRate() const { return initialLearningRate_; }
    virtual T biasLearningRateFactor() const { return biasLearningRate_; }
    virtual void setLearningRate(T rate) { initialLearningRate_ = rate; }
...
public:
    DryRunEstimator(const Core::Configuration& config) : Core::Component(config), Precursor(config) {}
    virtual std::string type() const { return "dry-run"; }
...
public:
    ...
    virtual ~Adam();
    virtual void estimate(NeuralNetwork<T>& network, Statistics<T>& statistics);
    virtual std::string type() const { return "adam"; }
    virtual u32 requiredStatistics() const { return Statistics<T>::GRADIENT ; }
    bool isDefaultConfig();
};
...
public:
    ...
    virtual ~AdaGrad();
    virtual void estimate(NeuralNetwork<T>& network, Statistics<T>& statistics);
    virtual std::string type() const { return "adagrad"; }
    virtual u32 requiredStatistics() const { return Statistics<T>::GRADIENT ; }
    bool isDefaultConfig();
};
...
public:
    ...
    virtual ~AdaDelta();
    virtual void estimate(NeuralNetwork<T>& network, Statistics<T>& statistics);
    virtual std::string type() const { return "adadelta"; }
    virtual u32 requiredStatistics() const { return Statistics<T>::GRADIENT ; }
    bool isDefaultConfig();
};
...
public:
    ...
    virtual ~RmsProp();
    virtual void estimate(NeuralNetwork<T>& network, Statistics<T>& statistics);
    virtual std::string type() const { return "rmsprop"; }
    virtual u32 requiredStatistics() const { return Statistics<T>::GRADIENT ; }
    bool isDefaultConfig();
};
