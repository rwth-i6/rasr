...
public:
    ...
    virtual Automaton* clone() const { return new Automaton; }
...
public:
     ...
     */
    virtual bool consumeInput() const { return true; }
    /**
     ...
     */
    virtual bool addInput(AutomatonRef) { return true; }
    /**
...
public:
    ...
    virtual u32 nInputAutomata() const { return 1; }
...
protected:
    virtual bool precondition() const { return input_; }
    AutomatonRef input_;
};
...
protected:
    enum OutputType
    {
        outputLemmaPronunciations, outputLemmas, outputSyntacticTokens
    };
...
protected:
    virtual AutomatonRef process() { return 0; }
public:
