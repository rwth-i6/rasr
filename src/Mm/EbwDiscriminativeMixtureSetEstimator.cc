...
bool EbwDiscriminativeMixtureSetEstimator::accumulateMixture(Core::BinaryInputStreams& is,
                                                             Core::BinaryOutputStream& os) {
    return EbwDiscriminativeMixtureEstimator::accumulate(is, os);
}

void EbwDiscriminativeMixtureSetEstimator::initialize(const MixtureSetEstimatorIndexMap& indexMaps,
...
EbwDiscriminativeMixtureEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createMixtureEstimator() {
    return new EbwDiscriminativeMixtureEstimatorWithISmoothing(mixtureEstimatorConfig_);
}

EbwDiscriminativeGaussDensityEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createDensityEstimator() {
    return new EbwDiscriminativeGaussDensityEstimatorWithISmoothing;
}

EbwDiscriminativeGaussDensityEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createDensityEstimator(const GaussDensity&) {
    return new EbwDiscriminativeGaussDensityEstimatorWithISmoothing;
}

EbwDiscriminativeMeanEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createMeanEstimator() {
    return new EbwDiscriminativeMeanEstimatorWithISmoothing;
}

EbwDiscriminativeMeanEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createMeanEstimator(const Mean& mean) {
    return new EbwDiscriminativeMeanEstimatorWithISmoothing(mean.size());
}

EbwDiscriminativeCovarianceEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createCovarianceEstimator() {
    return new EbwDiscriminativeCovarianceEstimatorWithISmoothing;
}

EbwDiscriminativeCovarianceEstimatorWithISmoothing* EbwDiscriminativeMixtureSetEstimatorWithISmoothing::createCovarianceEstimator(const Covariance& covariance) {
...
void EbwDiscriminativeMixtureSetEstimatorWithISmoothing::finalize(MixtureSet&                        toEstimate,
...
void EbwDiscriminativeMixtureSetEstimatorWithISmoothing::setIMixture(Core::Ref<AbstractMixtureEstimator> estimator,
...
void EbwDiscriminativeMixtureSetEstimatorWithISmoothing::setIDensity(Core::Ref<GaussDensityEstimator> estimator,
...
void EbwDiscriminativeMixtureSetEstimatorWithISmoothing::setIMean(Core::Ref<AbstractMeanEstimator> estimator,
                                                                  const Mean*                      mean,
                                                                  Weight                           iSmoothing) {
    EbwDiscriminativeMeanEstimatorWithISmoothing* _estimator = required_cast(EbwDiscriminativeMeanEstimatorWithISmoothing*, estimator.get());
    _estimator->setIMean(mean);
    _estimator->setConstant(iSmoothing);
}

void EbwDiscriminativeMixtureSetEstimatorWithISmoothing::setICovariance(Core::Ref<AbstractCovarianceEstimator> estimator,
                                                                        const Covariance*                      covariance,
                                                                        Weight                                 iSmoothing) {
    EbwDiscriminativeCovarianceEstimatorWithISmoothing* _estimator = required_cast(EbwDiscriminativeCovarianceEstimatorWithISmoothing*, estimator.get());
