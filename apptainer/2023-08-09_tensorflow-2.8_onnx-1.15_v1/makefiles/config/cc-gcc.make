...
CFLAGS		+= -std=c99
CXXFLAGS	+= -std=c++20
CXXFLAGS	+= -Wno-unknown-pragmas -Werror=return-type -Werror=reorder -Werror=format-security -Werror=delete-non-virtual-dtor -Werror=unused-but-set-variable -Werror=deprecated-enum-enum-conversion
#CCFLAGS	+= -pedantic
CCFLAGS		+= -fPIC
CCFLAGS		+= -Wall
