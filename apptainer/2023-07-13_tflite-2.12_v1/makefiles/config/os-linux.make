...
ifdef MODULE_TFLITE
ifndef TF_COMPILE_BASE
TF_COMPILE_BASE = /opt/tensorflow/tensorflow
endif

ifndef TFLITE_LIBDIR
  TFL_DEP := /opt/tensorflow/tensorflow/tflite_build/flatbuffers/include/
  TFLITE_LIBDIR := /opt/tensorflow/tensorflow/tflite_build/lib/tensorflow/lite
endif

TFL_CXXFLAGS = -fexceptions
TFL_CXXFLAGS += -I$(TF_COMPILE_BASE)
TFL_CXXFLAGS += -I$(TFL_DEP)
TFL_LDFLAGS  = -L$(TFLITE_LIBDIR)
TFL_LDFLAGS  += -ltensorflowlite -ldl
endif
