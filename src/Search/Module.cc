...
#include "ModelCombTreeTimesyncBeamSearch/ModelCombTreeTimesyncBeamSearch.hh"
...
const Core::Choice Module_::searchTypeV2Choice(
        ...
        "model-comb-tree-timesync-beam-search", SearchTypeV2::ModelCombTreeTimesyncBeamSearchType,
