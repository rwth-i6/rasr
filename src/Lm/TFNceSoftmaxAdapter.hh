...
class TFNceSoftmaxAdapter : public TFSoftmaxAdapter {
public:
    using Precursor = TFSoftmaxAdapter;

    TFNceSoftmaxAdapter(Core::Configuration const& config);
    virtual ~TFNceSoftmaxAdapter() = default;
...
inline TFNceSoftmaxAdapter::TFNceSoftmaxAdapter(Core::Configuration const& config)
        : Precursor(config) {
}
