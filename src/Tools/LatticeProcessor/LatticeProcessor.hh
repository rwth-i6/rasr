...
#include <Speech/AdvancedLatticeSetProcessor.hh>
#include <Speech/AdvancedWordLatticeExtractor.hh>
#include <Speech/NBestListExtractor.hh>
#endif
#ifdef MODULE_SEARCH_MBR
#include <Speech/MinimumBayesRiskSearch.hh>
#endif
...
public:
    ...
    enum Action {
        ...
        actionCollectLatticeCoverageStatistics,
        // accumulation
