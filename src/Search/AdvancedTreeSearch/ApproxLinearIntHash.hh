...
public:
  ApproxLinearIntHash() : size_( 0 ), mask_( 0 ) {
  }
...
//         const u16 marker = id >> 16;
//
//         if( sparseValues_[ pos ].value == U16_MAX )
//             return false;
//
//         if( sparseValues_[pos].mark ==  marker )
//         {
//             target = sparseValues_[ pos ].value;
//             return true;
//         }
//
...
//
//         if( isMarked( item2Value, marker ) )
//         {
//         target = item2Value;
//         return true;
//         }else if( item2Value == U16_MAX ) {
...
//         if( isMarked( item3Value, marker) )
//         {
//             target = item3Value;
//             return true;
//         }else if( item3Value == U16_MAX )
//             return false;           // The id wasn't found
//         }
