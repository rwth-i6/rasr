 ...
 * </properties-definition>
 */
class XmlIndexedStringBuilderElement : public XmlEmptyElement,
...
class XmlPropertiesDefinitionBuilderElement : public XmlRegularElement,
 ...
 * </questions>
 */
class XmlQuestionRefListBuilderElement : public XmlMixedElement,
 ...
 * </information>
 */
class XmlIgnoreInformationBuilderElement : public XmlIgnoreElement,
 ...
 * </information>
 */
class XmlTrainingInformationBuilderElement : public XmlMixedElement,
                                             public BuildDelegation<Information> {
protected:
...
class IgnoreInformationBuilder : public InformationBuilder {
private:
    XmlIgnoreInformationBuilderElement* infoBuilder_;

public:
    IgnoreInformationBuilder()
            : infoBuilder_(0) {}
    ~IgnoreInformationBuilder() {
        delete infoBuilder_;
    }
...
class TrainingInformationBuilder : public InformationBuilder {
private:
    XmlTrainingInformationBuilderElement* infoBuilder_;

public:
    TrainingInformationBuilder()
            : infoBuilder_(0) {}
    ~TrainingInformationBuilder() {
        delete infoBuilder_;
    }
 ...
 * </node>
 */
class XmlBinaryTreeRootBuilderElement : public XmlMixedElement,
 ...
 * </decision-tree>
 */
class XmlDecisionTreeBuilderElement : public XmlRegularElement,
...
public:
    XmlDecisionTreeBuilderElement(const char*         name,
                                  XmlContext*         context,
                                  InformationBuilder* infoBuilder = 0);
 ...
 */
class XmlDecisionTreeParser : public XmlSchemaParser {
protected:
...
public:
    XmlDecisionTreeParser(const Core::Configuration& config,
                          InformationBuilder*        infoBuilder = 0)
            : Precursor(config) {
        treeBuilder_ = new XmlDecisionTreeBuilderElement("decision-tree", this, infoBuilder);
 ...
 * </properties>
 */
class XmlPropertiesBuilderElement : public XmlRegularElement,
 ...
 * </matrix-f64>
 */
class XmlFloatBoxBuilderElement : public XmlEmptyElement,
 ...
 * </example-list>
 */
class XmlExampleListBuilderElement : public XmlRegularElement,
...
public:
    XmlExampleListBuilderElement(const char* name, XmlContext* context);
...
// ============================================================================
class XmlExampleListMergerElement : public XmlRegularElement,
                                    public BuildDelegation<ExampleList> {
protected:
...
public:
    XmlExampleListMergerElement(const char* name, XmlContext* context);
 ...
 */
class XmlExampleListParser : public XmlSchemaParser {
protected:
 ...
 */
class XmlExampleListMerger : public XmlSchemaParser {
protected:
 ...
 * </step>
 */
class XmlStepBuilderElement : public XmlMixedElement,
...
public:
    XmlStepBuilderElement(const char* name, XmlContext* context);

    ~XmlStepBuilderElement();

    void set(PropertyMapRef map) {
        questionRefsBuilder_->set(map);
    }
 ...
 * </decision-tree-training>
 */
class XmlTrainingPlanBuilderElement : public XmlRegularElement,
...
public:
    XmlTrainingPlanBuilderElement(const char* name, XmlContext* context);
 ...
 * as taken by the generic decision tree trainer
 */
class XmlTrainingPlanParser : public XmlSchemaParser {
protected:
...
public:
    XmlTrainingPlanParser(const Core::Configuration& config)
            : Precursor(config) {
        trainingPlanBuilder_ = new XmlTrainingPlanBuilderElement("decision-tree-training", this);
