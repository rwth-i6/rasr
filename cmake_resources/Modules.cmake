...
# ****** ONNX integration ******
add_module_option(MODULE_ONNX OFF)
...
if(${MODULE_MM_DT} AND ${MODULE_LATTICE_DT} AND ${MODULE_SPEECH_DT})
...
set(SEARCH_LIBS libRasrSearch)
if(${MODULE_SEARCH_WFST})
    list(APPEND SEARCH_LIBS libRasrSearchWfst libRasrOpenFst)
endif()
if(${MODULE_ADVANCED_TREE_SEARCH})
    list(APPEND SEARCH_LIBS libRasrAdvancedTreeSearch)
endif()
if(${MODULE_GENERIC_SEQ2SEQ_TREE_SEARCH})
    list(APPEND SEARCH_LIBS libRasrGenericSeq2SeqTreeSearch)
endif()
