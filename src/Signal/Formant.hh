...
class FormantExtraction : public virtual Core::Component {
public:
    typedef f32 _float;
...
protected:
    ...
    bool calculateContinuousModel(_float a1, _float a2, _float& resonance_frequency, _float& relative_damping);
...
public:
    ...
    u8 getMaxNrFormant() {
        return max_nr_formant_;
    }
    void setMaxNrFormant(u8 max_nr_formant) {
        max_nr_formant_ = max_nr_formant;
    }
