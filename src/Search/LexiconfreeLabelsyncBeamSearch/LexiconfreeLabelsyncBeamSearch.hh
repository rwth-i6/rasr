...
/*
 * Simple label synchronous beam search algorithm without pronunciation lexicon, word-level LM or transition model.
...
#endif  // LEXICONFREE_LABELSYNC_BEAM_SEARCH_HH
