...
public:
    explicit XmlOpen(const std::string& element)
            : element_(element) {}
...
public:
    explicit XmlClose(const std::string& element)
            : element_(element) {}
    XmlClose(const XmlOpen& open)
            : element_(open.element()) {}
};

class XmlEmpty : public XmlOpen {
...
public:
    explicit XmlEmpty(const std::string& element)
            : XmlOpen(element) {}
    Self& operator+(const XmlAttribute& attribute) {
        attributes_.push_back(attribute);
        return *this;
...
public:
    explicit XmlComment(const std::string& text)
            : text_(text) {}
};
...
protected:
    ...
    bool shouldGenerateFormattingHints() const {
        return formattingHints_;
    }
...
public:
...
#ifdef OS_darwin
    Self& operator<<(size_t t) {
        std::ostream::operator<<(t);
        return *this;
    }
#endif
#ifndef __SUNPRO_CC
    Self& operator<<(char t) {
        std::ostream::operator<<(t);
        return *this;
    }
#endif
    Self& operator<<(bool t) {
        std::ostream::operator<<(t);
        return *this;
    }
    Self& operator<<(void* t) {
        std::ostream::operator<<(t);
        return *this;
    }
    Self& operator<<(const char* t) {
    ...
    Self& operator<<(const XmlOpen& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlClose& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlEmpty& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlFull& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlComment& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlOpenComment& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlCloseComment& t) {
        put(t);
        return *this;
    }
    Self& operator<<(const XmlBlank& t) {
        put(t);
        return *this;
    }
};
...
class XmlOutputStream : public XmlWriter {
...
public:
    ...
    const std::string& encoding() const {
        return textOutputStream_.encoding();
    }
    void setEncoding(const std::string& encoding = UnicodeOutputConverter::defaultEncoding) {
        textOutputStream_.setEncoding(encoding);
    }
    void setIndentation(u32 n) {
        textOutputStream_.setIndentation(n);
    }
    void setMargin(u32 m) {
        textOutputStream_.setMargin(m);
    }
    void putDeclaration();
};
