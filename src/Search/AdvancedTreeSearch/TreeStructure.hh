...
struct HMMState {
  inline_ HMMState() : successors( InvalidBatchId ) {
  }
...
public:
  ...
  struct SuccessorIterator : public Tools::BatchIndexIterator<SuccessorBatchId, StateId, InvalidBatchId, SingleSuccessorBatchMask> {
    SuccessorIterator( SuccessorBatchId batchId, const std::vector<StateId>& batches ) : Tools::BatchIndexIterator<SuccessorBatchId, StateId, InvalidBatchId, SingleSuccessorBatchMask>( batchId, batches ) {
    }
