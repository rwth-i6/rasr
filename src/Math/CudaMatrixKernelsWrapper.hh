...
inline void convExtractPatches(const T * input, const int * patchIdx, T *patches,
    ...
    CUDACALL((_cuda_convExtractPatches(input, patchIdx, patches,
                inverse_patches,
...
inline void convUnwarpFrames(const T *output_warped, const T *bias, T *output,
    ...
    CUDACALL((_cuda_convUnwarpFrames(output_warped, bias, output,
                output_dim, filter_num, shifts_num, input_frames)),
            "convUnwarpFrames");
}
...
inline void convWarpFrames(const T *error_unwarped, T *output,
    ...
    CUDACALL((_cuda_convWarpFrames(error_unwarped, output,
                error_dim, filter_num, shifts_num, input_frames)),
            "convWarpFrames");
}
