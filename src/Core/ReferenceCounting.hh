...
public:
    ...
    template<class S>
    Ref& operator=(const Ref<S>& rhs) {
        set(rhs._get());
        return *this;
    }
    template<class S>
    Ref& operator=(const WeakRef<S>& rhs) {
        set(rhs._get());
        return *this;
    }
    ...
    template<class S>
    bool operator==(const Ref<S>& r) const {
        return object_ == r._get();
    }
    template<class S>
    bool operator==(const WeakRef<S>& r) const {
        return object_ == r._get();
    }
...
public:
     ...
     */
    template<class S>
    WeakRef(const WeakRef<S>& r)
            : object_(r._get()) {
        acquire();
    }
    template<class S>
    WeakRef(const Ref<S>& r)
            : object_(r._get()) {
        acquire();
    }
    ...
    template<class S>
    WeakRef& operator=(const WeakRef<S>& rhs) {
        set(rhs._get());
        return *this;
    }
    template<class S>
    WeakRef& operator=(const Ref<S>& rhs) {
        set(rhs._get());
        return *this;
    }
