...
AbstractParameter::AbstractParameter(const char* _ident,
                                     char        _abbrev,
    ...
    if (strlen(_ident) > g_param_max_ident)
        g_param_max_ident = strlen(_ident);
}
...
template<class T>
Parameter<T>::Parameter(const char*  ident,
                        const char*  s_desc,
...
template<class T>
RangedParameter<T>::RangedParameter(const char*  ident,
                                    const char*  s_desc,
                                    const Value& defaultValue,
...
ParameterBool::ParameterBool(const char* ident,
                             const char* s_desc,
                             bool        defaultValue,
                             const char* l_desc)
...
ParameterInt::ParameterInt(const char* ident,
                           const char* s_desc,
                           s32         defaultValue,
                           s32         minValue,
                           s32         maxValue,
...
ParameterFloat::ParameterFloat(const char* ident,
                               const char* s_desc,
                               f64         defaultValue,
                               f64         minValue,
                               f64         maxValue,
...
ParameterChoice::ParameterChoice(const char*   ident,
                                 const Choice* c,
                                 const char*   s_desc,
                                 s32           defaultValue,
                                 const char*   l_desc)
...
ParameterString::ParameterString(const char* ident,
                                 const char* s_desc,
...
ParameterBitVector::ParameterBitVector(const char*              ident,
                                       const char*              s_desc,
...
// VectorParameter
template<class T>
VectorParameter<T>::VectorParameter(const char*       ident,
                                    const char*       s_desc,
...
ParameterStringVector::ParameterStringVector(const char*       ident,
                                             const char*       s_desc,
                                             const std::string delimiter,
                                             const Size        minSize,
                                             const Size        maxSize,
...
ParameterIntVector::ParameterIntVector(const char*       ident,
                                       const char*       s_desc,
                                       const std::string delimiter,
                                       const s32         minValue,
                                       const s32         maxValue,
...
ParameterFloatVector::ParameterFloatVector(const char*       ident,
                                           const char*       s_desc,
                                           const std::string delimiter,
                                           const f64         minValue,
                                           const f64         maxValue,
...
ParameterWeightVector::ParameterWeightVector(const char*       ident,
                                             const char*       s_desc,
                                             const std::string delimiter,
