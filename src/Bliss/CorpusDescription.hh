...
class ParentEntity : public NamedCorpusEntity {
private:
 ...
 * Also has left/right-context transcription. These can be used during
 * forced alignment as optional words to align (Usefull in case of noisy transcriptions)
 */
...
class CorpusVisitor : public SegmentVisitor {
public:
    /**
...
class CorpusDescription : public Core::Component {
private:
