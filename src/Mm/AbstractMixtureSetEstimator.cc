...
{
#if 0
    /* First remove all completely unseen means (i.e. it is equivalent with removing all
     * completely unseen densities) to avoid dividing by zero during covariance estimation. */
    removeDensitiesWithZeroWeight();
#endif
