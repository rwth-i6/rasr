 ...
 */
void DiscriminativeGaussDensityEstimator::accumulateDenominator(const FeatureVector& featureVector, Weight weight) {
...
void DiscriminativeMeanEstimator::accumulateDenominator(const std::vector<FeatureType>& v, Weight w) {
...
void DiscriminativeCovarianceEstimator::accumulateDenominator(const std::vector<FeatureType>& v, Weight w) {
    accumulator_.accumulate(v, -w);
}
