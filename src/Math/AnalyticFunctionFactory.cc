...
bool AnalyticFunctionFactory::accept(const std::string& s, const std::string& declaration, std::string::size_type& position) const {
...
bool AnalyticFunctionFactory::accept(UnaryAnalyticFunction::Argument& a, const std::string& declaration, std::string::size_type& position) const {
    acceptWhitespaces(declaration, position);
    if (position != std::string::npos) {
...
void AnalyticFunctionFactory::acceptWhitespaces(const std::string& declaration, std::string::size_type& position) const {
    if (position != std::string::npos)
...
BinaryAnalyticFunctionRef AnalyticFunctionFactory::castToBinaryFunction(AnalyticFunctionRef r) const {
    ...
    if (p == 0) {
        if (r)
            error("Function is not binary.");
        return BinaryAnalyticFunctionRef();
    }
    return BinaryAnalyticFunctionRef(p);
}

AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::create(const std::string& declaration) const {
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::create(const std::string&      declaration,
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseNesting(const std::string&      declaration,
                                                                                   std::string::size_type& position) const {
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseInvertion(const std::string&      declaration,
                                                                                     std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseMaximumNormalization(const std::string&      declaration,
                                                                                                std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseIdentity(const std::string&      declaration,
                                                                                    std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseConstant(const std::string&      declaration,
                                                                                    std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseOffset(const std::string&      declaration,
                                                                                  std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseScaling(const std::string&      declaration,
                                                                                   std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseAddition(const std::string&      declaration,
                                                                                    std::string::size_type& position) const {
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseSubstraction(const std::string&      declaration,
                                                                                        std::string::size_type& position) const {
    BinaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseMultiplication(const std::string&      declaration,
                                                                                          std::string::size_type& position) const {
    BinaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseDivision(const std::string&      declaration,
                                                                                    std::string::size_type& position) const {
    BinaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseSinh(const std::string&      declaration,
                                                                                std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseArcSinh(const std::string&      declaration,
                                                                                   std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseCosh(const std::string&      declaration,
                                                                                std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseArcCosh(const std::string&      declaration,
                                                                                   std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseDiscreteToContinuous(const std::string&      declaration,
                                                                                                std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseContinuousToDiscrete(const std::string&      declaration,
                                                                                                std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseMelWarpingFunction(const std::string&      declaration,
                                                                                              std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef AnalyticFunctionFactory::createBarkWarpingFunction() const {
    UnaryAnalyticFunctionRef continuous = nest(createScaling(6.0), nest(createSinh()->invert(), createScaling(1.0 / 600.0)));
    switch (domainType_) {
        case continuousDomain:
            return continuous;
        case discreteDomain:
        ...
        case normalizedOmegaDomain:
            // sampleRate_: sample rate in time domain
            return nest(createScaling((2 * M_PI) / sampleRate_), nest(continuous, createScaling(sampleRate_ / (2 * M_PI))));
        default:
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseBarkWarpingFunction(const std::string&      declaration,
                                                                                               std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef AnalyticFunctionFactory::createTwoPieceLinearFunction(UnaryAnalyticFunction::Argument warpingFactor,
                                                                               UnaryAnalyticFunction::Argument limit) const {
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseTwoPieceLinearFunction(const std::string&      declaration,
                                                                                                  std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseBilinearWarpingFunction(const std::string&      declaration,
                                                                                                   std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
UnaryAnalyticFunctionRef AnalyticFunctionFactory::createThreePieceAffineFunction(UnaryAnalyticFunction::Argument warpingFactor,
    ...
    if (warpingFactor <= 1) {
        ...
        result->add(lowerLimit * maximalArgument_,
                    (warpingFactor * lowerLimit * maximalArgument_ +
                     (aShift * (warpingFactor - 1))) /
                            (lowerLimit * maximalArgument_));
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseThreePieceAffineFunction(const std::string&      declaration,
                                                                                                    std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseEqualLoudnessPreemphasis(const std::string&      declaration,
                                                                                                    std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
...
AnalyticFunctionFactory::AnalyticFunctionRef AnalyticFunctionFactory::parseEqualLoudnessPreemphasis40dB(const std::string&      declaration,
                                                                                                        std::string::size_type& position) const {
    UnaryAnalyticFunctionRef result;
