...
public:
  LinearMiniHash( Value defaultValue ) : size_( 0 ), mask_( 0 ), defaultValue_( defaultValue ) {
  }
...
//     if(sparseSkipHash.find(id) == sparseSkipHash.end()) sparseSkipHash[id] = std::make_pair<u32, u32>(0, 0);
