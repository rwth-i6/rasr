...
template<>
class XmlDataOnlyBuilderElement<std::string, StringConversion<std::string>> : public Core::XmlEmptyElement,
...
class XmlChoiceBuilderElement : public Core::XmlEmptyElement,
