...
private:
    ...
    private:
        void storeSymbols(const std::vector<std::string>& symbols) {
            symbols_  = symbols;
            needInit_ = true;
        }
        void storeComplementing(bool shallComplement) {
            setComplementing(shallComplement);
            needInit_ = true;
        }
        void setComplementing(bool shallComplement) {
            shallComplement_ = shallComplement;
        }
        /**
    ...
    public:
        StateSet(const Core::Configuration& c)
                : Precursor(c) {}
        virtual ~StateSet() {}
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-to-sequence-selection";
    }
