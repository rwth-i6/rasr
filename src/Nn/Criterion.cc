...
void CrossEntropyCriterion<FloatT>::getObjectiveFunction(FloatT& value) {
    ...
    if(Precursor::weights_)
        value = Precursor::nnOutput_->weightedCrossEntropyObjectiveFunction(
...
template<typename FloatT>
void CrossEntropyCriterion<FloatT>::getErrorSignal_naturalPairing
(NnMatrix& errorSignal, NeuralNetworkLayer<FloatT>& lastLayer) {
    require(Precursor::nnOutput_);
...
template<typename FloatT>
void SquaredErrorCriterion<FloatT>::getErrorSignal_naturalPairing
(NnMatrix& errorSignal, NeuralNetworkLayer<FloatT>& lastLayer) {
    require(Precursor::nnOutput_);
    require(Precursor::alignment_); // not implemented yet without fixed alignment
...
template<typename FloatT>
void BinaryDivergenceCriterion<FloatT>::getErrorSignal_naturalPairing
(NnMatrix& errorSignal, NeuralNetworkLayer<FloatT>& lastLayer) {
    require(Precursor::nnOutput_);
    require(Precursor::alignment_); // not implemented yet without fixed alignment
