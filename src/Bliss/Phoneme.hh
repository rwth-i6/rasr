...
struct u16_char_traits {
    ...
    static void assign(u16& __c1, const u16& __c2) {
        __c1 = __c2;
    }

    static bool eq(const u16& __c1, const u16& __c2) {
        return __c1 == __c2;
    }

    static bool lt(const u16& __c1, const u16& __c2) {
        return __c1 < __c2;
    }

    static int compare(const u16* __s1, const u16* __s2, size_t __n) {
    ...
    static const u16* find(const u16* __s, size_t __n, const u16& __a) {
    ...
    static u16* move(u16* __s1, const u16* __s2, size_t __n) {
        return static_cast<u16*>(memmove(__s1, __s2, 2 * __n));
    }

    static u16* copy(u16* __s1, const u16* __s2, size_t __n) {
        return static_cast<u16*>(memcpy(__s1, __s2, 2 * __n));
    }

    static u16* assign(u16* __s, size_t __n, u16 __a) {
        u16* ptr = __s;
        for (unsigned int i = 1; i <= __n; i++) {
            *ptr = __a;
            ptr++;
    ...
    static u16 to_char_type(const int& __c) {
        return static_cast<u16>(__c);
    }

    // To keep both the byte 0xff and the eof symbol 0xffffffff
    // from ending up as 0xffffffff.
    static int to_int_type(const u16& __c) {
        return static_cast<int>(__c);
    }

    static bool eq_int_type(const int& __c1, const int& __c2) {
        return __c1 == __c2;
    }
    ...
    static int not_eof(const int& __c) {
...
public:
    ...
    std::pair<PhonemeIterator, PhonemeIterator> phonemes() const {
        return std::make_pair(PhonemeIterator(phonemes_.begin() + 1),
