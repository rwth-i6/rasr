...
public:
        CachedAcousticAccumulator(
            ...
            Trainer *trainer, Mm::Weight weightThreshold, Core::Ref<const Am::AcousticModel> acousticModel,
            Mm::Weight factor);
        virtual ~CachedAcousticAccumulator() {}
        virtual void finish();
        void accumulate(Speech::TimeframeIndex t, Mm::MixtureIndex m, Mm::Weight w) {this->trainer_->accumulate(t,m,w); }
