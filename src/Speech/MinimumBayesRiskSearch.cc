...
//#include <Lattice/RemoveSilencesAndNoises.hh>
...
namespace Speech
{
    ...
    Lattice::ConstWordLatticeRef MinimumBayesRiskSearchNode::mapEvalToLemmaPronunciation(
        Fsa::ConstAutomatonRef eval, Lattice::ConstWordLatticeRef lattice)
    {
    ...
    void MinimumBayesRiskSearchNode::initialize(Bliss::LexiconRef lexicon)
    {
        ...
        lemmaToEval_ =
            Fsa::multiply(
                lexicon_->createLemmaToEvaluationTokenTransducer(),
                Fsa::Weight(0.0));
    ...
    void MinimumBayesRiskSearchNode::processWordLattice(
