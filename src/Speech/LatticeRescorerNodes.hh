...
namespace Speech {
    ...
    public:
        static std::string filterName() { return "lattice-numerator-from-denominator"; }
    ...
    public:
        ...
        virtual Flow::PortId getInput(const std::string &name) {
            if (name == "model-combination") return 0;
            else if (name == "lattice") return 1;
            else if (name == "alignment-generator") return 2;
            else if (name == "reference") return 3;
            else return Flow::IllegalPortId;
        }
        virtual bool configure();
        virtual bool work(Flow::PortId);
    };
    ...
    class ApproximatePhoneAccuracyLatticeRescorerNode :
        public ApproximateDistanceLatticeRescorerNode
    {
    ...
    protected:
        ...
        virtual Fsa::ConstAutomatonRef getDistanceFsa(
            Lattice::ConstWordLatticeRef, Lattice::ConstWordLatticeRef);
    public:
        static std::string filterName() { return "lattice-approximate-phone-accuracy"; }
    ...
    class FramePhoneAccuracyLatticeRescorerNode :
        public ApproximateDistanceLatticeRescorerNode
    {
        typedef ApproximateDistanceLatticeRescorerNode Precursor;
    private:
    ...
    protected:
        ...
        virtual Fsa::ConstAutomatonRef getDistanceFsa(
            Lattice::ConstWordLatticeRef, Lattice::ConstWordLatticeRef);
    public:
        static std::string filterName() { return "lattice-frame-phone-accuracy"; }
    ...
    class SoftFramePhoneAccuracyLatticeRescorerNode :
        public ApproximateDistanceLatticeRescorerNode
    {
        typedef ApproximateDistanceLatticeRescorerNode Precursor;
    private:
    ...
    public:
        static std::string filterName() { return "lattice-soft-frame-phone-accuracy"; }
    ...
    class WeightedFramePhoneAccuracyLatticeRescorerNode :
        public ApproximateDistanceLatticeRescorerNode
    {
        typedef ApproximateDistanceLatticeRescorerNode Precursor;
    private:
    ...
    protected:
        ...
        virtual Fsa::ConstAutomatonRef getDistanceFsa(
            Lattice::ConstWordLatticeRef, Lattice::ConstWordLatticeRef);
    public:
        static std::string filterName() { return "lattice-weighted-frame-phone-accuracy"; }
    ...
    public:
        ...
        static std::string filterName() { return "lattice-acoustic-arc-rescoring"; }
    };
     ...
     */
    class AlignmentAcousticLatticeRescorerNode :
        public AcousticLatticeRescorerNode
    {
        typedef AcousticLatticeRescorerNode Precursor;
    protected:
        virtual Fsa::ConstAutomatonRef getRescoredFsa(Lattice::ConstWordLatticeRef);
    public:
        static std::string filterName() { return "lattice-alignment-acoustic"; }
