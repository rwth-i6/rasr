 ...
 */
class ISmoothingMixtureSetEstimator : public virtual Core::Component {
private:
...
public:
    ...
    Weight weightsConstant() const {
        return weightsConstant_;
    }
    Weight meansConstant() const {
        return meansConstant_;
    }
};
