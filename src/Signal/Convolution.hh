...
namespace Signal {
    ...
    private:
        ...
        u32 fourierTransformLength() const { return maximalSignalSize_ + responseSize_ - 1; }
    ...
    public:
        ...
        u32 maximalSignalSize() const { return maximalSignalSize_; }

        /** result of convolution is delived for the interval [outputBegin_..outputEnd_) */
        void setOutputBegin(u32 begin) { outputBegin_ = begin; }
        u32 outputBegin() const { return outputBegin_; }
         ...
         */
        void setOutputEnd(u32 end) { outputEnd_ = end; }
        u32 outputEnd() const { return outputEnd_; }
    };
}
