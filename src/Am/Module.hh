...
private:
    ...
    class ClassicStateTyingFactory : public Core::Factory<ClassicStateTying,
...
public:
     ...
     * an error occured.
     */
    Core::Ref<AcousticModel> createAcousticModel(const Core::Configuration&, Bliss::LexiconRef,
