...
private:
    void registerFunctionParser(ParserFunction function) {
        parserFunctions_.push_back(function);
    }
     ...
     */
    AnalyticFunctionRef parseNesting(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a inverse function object f(x)^(-1).
     *  Declaration syntax: invert(f).
     */
    AnalyticFunctionRef parseInvertion(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a maximum normalization function object f(x)^(-1).
     *  Declaration syntax: norm-max(f).
     */
    AnalyticFunctionRef parseMaximumNormalization(const std::string& declaration, std::string::size_type& position) const;

    /** Creates an identity function object f(x) = x.
     *  Declaration syntax: identity.
     */
    AnalyticFunctionRef parseIdentity(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a constant function object f(x) = c.
     *  Declaration syntax: const(c).
     */
    AnalyticFunctionRef parseConstant(const std::string& declaration, std::string::size_type& position) const;
    /** Creates an offset function object f(x) = x + b.
     *  Declaration syntax: offset(b).
     */
    AnalyticFunctionRef parseOffset(const std::string& declaration, std::string::size_type& position) const;
    /** Creates an scaling function object f(x) = a * x.
     *  Declaration syntax: scaling(a).
     */
    AnalyticFunctionRef parseScaling(const std::string& declaration, std::string::size_type& position) const;

    /** Creates a addition function object f(x, y) = x + y.
     *  Declaration syntax: plus.
     */
    AnalyticFunctionRef parseAddition(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a addition function object f(x, y) = x - y.
     *  Declaration syntax: minus.
     */
    AnalyticFunctionRef parseSubstraction(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a addition function object f(x, y) = x * y.
     *  Declaration syntax: multiplies.
     */
    AnalyticFunctionRef parseMultiplication(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a addition function object f(x, y) = x / y.
     *  Declaration syntax: divides.
     */
    AnalyticFunctionRef parseDivision(const std::string& declaration, std::string::size_type& position) const;

    /** Creates an Sinh function object f(x) = sinh(x).
     *  Declaration syntax: sinh.
     */
    AnalyticFunctionRef parseSinh(const std::string& declaration, std::string::size_type& position) const;
    /** Creates an ArcSinh function object f(x) = asinh(x).
     *  Declaration syntax: asinh.
     */
    AnalyticFunctionRef parseArcSinh(const std::string& declaration, std::string::size_type& position) const;
    /** Creates an Sinh function object f(x) = cosh(x).
     *  Declaration syntax: cosh.
     */
    AnalyticFunctionRef parseCosh(const std::string& declaration, std::string::size_type& position) const;
    /** Creates an ArcSinh function object f(x) = acosh(x).
     *  Declaration syntax: acosh.
     */
    AnalyticFunctionRef parseArcCosh(const std::string& declaration, std::string::size_type& position) const;

    /** Creates an scaling function object f(x) = x / sampleRate_.
     *  Declaration syntax: disc-to-cont.
     */
    AnalyticFunctionRef parseDiscreteToContinuous(const std::string& declaration, std::string::size_type& position) const;
    /** Creates an scaling function object f(x) = x * sampleRate_.
     *  Declaration syntax: cont-to-disc.
     */
    AnalyticFunctionRef parseContinuousToDiscrete(const std::string& declaration, std::string::size_type& position) const;

    /** Creates a mel warping function object (@see createMelWarpingFunction).
     *  Declaration syntax: mel or mel(discretize-input).
     */
    AnalyticFunctionRef parseMelWarpingFunction(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a bark warping function object (@see createBarkWarpingFunction).
     *  Declaration syntax: bark.
     */
    AnalyticFunctionRef parseBarkWarpingFunction(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a two-piece linear function function object (@see createTwoPieceLinearFunction).
     *  Declaration syntax: linear-2(a, limit).
     */
    AnalyticFunctionRef parseTwoPieceLinearFunction(const std::string& declaration, std::string::size_type& position) const;
    /** Creates a bilinear warping function object (@see createBilinearWarpingFunction).
     *  Declaration syntax: bilinear(a).
     */
    AnalyticFunctionRef parseBilinearWarpingFunction(const std::string& declaration, std::string::size_type& position) const;
     ...
     */
    AnalyticFunctionRef parseThreePieceAffineFunction(const std::string& declaration, std::string::size_type& position) const;
     ...
     */
    AnalyticFunctionRef parseEqualLoudnessPreemphasis(const std::string& declaration, std::string::size_type& position) const;

    /** Creates a equal loudness preemphasis object for 40dB
     *  For details @see createEqualLoudnessPreemphasis40dB.
     */
    AnalyticFunctionRef parseEqualLoudnessPreemphasis40dB(const std::string& declaration, std::string::size_type& position) const;
...
public:
    ...
    void setSampleRate(UnaryAnalyticFunction::Argument sampleRate) {
        sampleRate_ = sampleRate;
    }
    void setMaximalArgument(UnaryAnalyticFunction::Argument maximum) {
        maximalArgument_ = maximum;
    }
...
public:
    ...
    static UnaryAnalyticFunctionRef createSinh() {
        return UnaryAnalyticFunctionRef(new Sinh);
    }
    /** Creates an object of Cosh */
    static UnaryAnalyticFunctionRef createCosh() {
...
public:
     ...
     *   with (limit, 1/a).
     */
    UnaryAnalyticFunctionRef createTwoPieceLinearFunction(UnaryAnalyticFunction::Argument warpingFactor,
     ...
     */
    UnaryAnalyticFunctionRef createBilinearWarpingFunction(UnaryAnalyticFunction::Argument warpingFactor) const {
     ...
     */
    UnaryAnalyticFunctionRef createThreePieceAffineFunction(UnaryAnalyticFunction::Argument warpingFactor,
