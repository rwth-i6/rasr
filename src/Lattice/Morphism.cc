...
MorphismAutomaton::MorphismAutomaton(Fsa::ConstAutomatonRef    fsa,
...
UnaryMorphismAutomaton::UnaryMorphismAutomaton(Fsa::ConstAutomatonRef          fsa,
...
ConstWordLatticeRef resolveMorphism(ConstWordLatticeRef             l,
                                    Core::Ref<const WordBoundaries> wordBoundaries,
                                    Fsa::ConstMappingRef            morphism) {
...
public:
    NaryMorphismAutomaton(Fsa::ConstAutomatonRef,
...
NaryMorphismAutomaton::NaryMorphismAutomaton(Fsa::ConstAutomatonRef                               fsa,
...
ConstWordLatticeRef resolveNaryMorphism(ConstWordLatticeRef                                  l,
                                        const Core::Vector<Core::Ref<const WordBoundaries>>& wordBoundaries,
                                        const Core::Vector<Fsa::ConstMappingRef>&            morphisms) {
    Core::Ref<WordBoundaries> _wordBoundaries(new WordBoundaries());
    WordLattice*              result = new WordLattice();
