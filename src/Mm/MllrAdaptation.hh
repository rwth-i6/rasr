...
public:
    ...
    virtual bool dump(Core::XmlOutputStream& xos) {
        defect();
    }
};
...
public:
    ...
    const std::map<NodeId, Matrix>& adaptationMatrices() const {
        return adaptationMatrices_;
    }
    const Math::Vector<double>& shiftVector(MixtureIndex mix);

    virtual std::string typeName() const {
        return "shift-adaptor";
    }
    virtual bool write(Core::BinaryOutputStream& o) const;
    virtual bool read(Core::BinaryInputStream& i);
};
...
public:
    ...
    virtual Sum minAdaptationObservations() {
        return minAdaptationObservations_;
    }
    ...
    virtual std::string typeName() const {
        return "shift-adaptor-viterbi-estimator";
    }
    virtual bool write(Core::BinaryOutputStream& o) const;
    virtual bool read(Core::BinaryInputStream& i);
};
...
public:
    ...
    virtual std::string typeName() const {
        return "full-adaptor-viterbi-estimator";
    }
    virtual bool write(Core::BinaryOutputStream& o) const;
    virtual bool read(Core::BinaryInputStream& i);
};
