...
public:
    ...
    u32 highestTrainableLayerIndex() const { return highestTrainableLayerIndex_; }
    u32 lowestTrainableLayerIndex() const { return lowestTrainableLayerIndex_; }
    ...
    u32 getLayerIdByName(const std::string &name) { return topology_.layerElement(name)->topologicalId(); }
