...
public:
    LatticeArchive(const Core::Configuration &c) : Core::Component(c), archive_(0), path_(paramPath(c)) {}
    LatticeArchive(const Core::Configuration &c, const std::string &path) : Core::Component(c), archive_(0), path_(path) {}
