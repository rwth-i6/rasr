...
public:
    StatePotentials()
            : Precursor() {}
    StatePotentials(size_t size)
            : Precursor(size) {}
    StatePotentials(size_t size, const Weight& t)
            : Precursor(size, t) {}
};
...
public:
    IsInputLabel(Fsa::LabelId label)
            : label_(label) {}
    virtual bool operator()(const _Arc& a) const {
        return (a.input() == label_);
    }
};
...
public:
    AreBothLabels(Fsa::LabelId label)
            : label_(label) {}
    virtual bool operator()(const _Arc& a) const {
