...
private:
    void setColor(Fsa::StateId s, Color c) {
        info_[s] = (info_[s] & Fsa::StateIdMask) | c;
    }
    void setPredecessor(Fsa::StateId s, Fsa::StateId p) {
        info_[s] = (info_[s] & ~Fsa::StateIdMask) | p;
    }
...
public:
     ...
     **/
    Color color(Fsa::StateId s) const {
        return info_[s] & ~Fsa::StateIdMask;
    }
     ...
     **/
    Fsa::StateId predecessor(Fsa::StateId s) const {
        return info_[s] & Fsa::StateIdMask;
    }
