...
TimeAlignmentBasedMetricLatticeBuilder::TimeAlignmentBasedMetricLatticeBuilder(const Core::Configuration& c,
...
void TimeAlignmentBasedMetricLatticeBuilder::setReference(Lattice::ConstWordLatticeRef reference) {
    reference_.reset();
        ...
        switch (tokenType_) {
            ...
            case phoneType: {
                if (lemma->nPronunciations() == 0) {
                    error("Short-pauses lemma \"") << lemma->name() << "\" does not have any pronunciation.";
                }
 ...
 */
OrthographyTimeAlignmentBasedMetricLatticeBuilder::OrthographyTimeAlignmentBasedMetricLatticeBuilder(const Core::Configuration& c,
                                                                                                     Bliss::LexiconRef          lexicon)
        : Precursor(c, lexicon) {
...
OrthographyTimeAlignmentBasedMetricLatticeBuilder::Functor
    ...
    setReference(Lattice::extractNumerator(orth,
                                           lattice,
                                           orthToLemma_,
                                           lemmaPronToLemma_,
...
ArchiveTimeAlignmentBasedMetricLatticeBuilder::ArchiveTimeAlignmentBasedMetricLatticeBuilder(const Core::Configuration& c,
                                                                                             Bliss::LexiconRef          lexicon)
        : Precursor(c, lexicon),
          name_(paramName(config)) {
    numeratorArchiveReader_ = Lattice::Archive::openForReading(select("numerator-lattice-archive"), lexicon);
 ...
 */
OrthographyApproximateWordAccuracyLatticeBuilder::OrthographyApproximateWordAccuracyLatticeBuilder(const Core::Configuration&      c,
...
Fsa::ConstAutomatonRef OrthographyApproximateWordAccuracyLatticeBuilder::build(Lattice::ConstWordLatticeRef lattice) {
    if (reference_) {
        Lattice::ConstWordLatticeRef result = Lattice::getApproximateWordAccuracy(lattice,
                                                                                  reference_,
                                                                                  shortPauses_,
 ...
 * ArchiveApproximateWordAccuracyLatticeBuilder
 */
ArchiveApproximateWordAccuracyLatticeBuilder::ArchiveApproximateWordAccuracyLatticeBuilder(const Core::Configuration&      c,
                                                                                           Core::Ref<const Bliss::Lexicon> lexicon)
        : Precursor(c, lexicon) {
    tokenType_ = (TokenType)paramTokenType(config);
    if (tokenType_ != lemmaPronunciationType && tokenType_ != lemmaType) {
...
Fsa::ConstAutomatonRef ArchiveApproximateWordAccuracyLatticeBuilder::build(Lattice::ConstWordLatticeRef lattice) {
    if (reference_) {
        Lattice::ConstWordLatticeRef result = Lattice::getApproximateWordAccuracy(lattice,
                                                                                  reference_,
                                                                                  shortPauses_,
 ...
 */
OrthographyApproximatePhoneAccuracyLatticeBuilder::OrthographyApproximatePhoneAccuracyLatticeBuilder(const Core::Configuration&      c,
                                                                                                     Core::Ref<const Bliss::Lexicon> lexicon)
        : Precursor(c, lexicon) {
...
Fsa::ConstAutomatonRef OrthographyApproximatePhoneAccuracyLatticeBuilder::build(Lattice::ConstWordLatticeRef lattice) {
    if (reference_) {
        Lattice::ConstWordLatticeRef result = Lattice::getApproximatePhoneAccuracy(lattice,
                                                                                   reference_,
                                                                                   shortPauses_,
                                                                                   alignmentGenerator_);
        return result->mainPart();
 ...
 */
ArchiveApproximatePhoneAccuracyLatticeBuilder::ArchiveApproximatePhoneAccuracyLatticeBuilder(const Core::Configuration&      c,
                                                                                             Core::Ref<const Bliss::Lexicon> lexicon)
        : Precursor(c, lexicon) {
    tokenType_ = phoneType;
    initializeShortPauses(lexicon);
 ...
 */
ApproximatePhoneAccuracyLatticeBuilder::ApproximatePhoneAccuracyLatticeBuilder(const Core::Configuration& c,
                                                                               Bliss::LexiconRef          lexicon)
        : Precursor(c, lexicon) {
    tokenType_ = phoneType;
    initializeShortPauses(lexicon);
...
Fsa::ConstAutomatonRef ApproximatePhoneAccuracyLatticeBuilder::build(Lattice::ConstWordLatticeRef lattice) {
    if (reference_) {
        Lattice::ConstWordLatticeRef result = Lattice::getApproximatePhoneAccuracy(lattice,
                                                                                   reference_,
                                                                                   shortPauses_,
