    ...
    if (pronunciation && begtime != InvalidTimeframeIndex) {
        ...
        if (begtime < endtime) {
            ...
            Core::Application::us()->warning("score 0 assigned to arc with begin time ")
                << begtime << " , end time " << endtime << " and label id " << a.input();
        }
    }
...
EmissionLatticeRescorer::EmissionLatticeRescorer(
    ...
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    ...
    EmissionLatticeRescorerAutomaton *f =
        new EmissionLatticeRescorerAutomaton(
            lattice, alignmentGenerator_, features, acousticModel_);
...
TdpLatticeRescorerAutomaton::TdpLatticeRescorerAutomaton(
    Lattice::ConstWordLatticeRef lattice,
    AlignmentGeneratorRef alignmentGenerator,
...
{
    Fsa::Weight score = fsa_->semiring()->one();
    ...
    if (pronunciation && begtime != InvalidTimeframeIndex) {
        ...
        if (begtime < endtime) {
            ...
            score = Fsa::bestscore(allophoneStateGraphBuilder_->build(
                                       *alignment,
                                       Bliss::Coarticulated<Bliss::Pronunciation>(
                                           *coarticulatedPronunciation.object().pronunciation(),
    ...
    TimeframeIndex begtime, TimeframeIndex endtime) const
{
    if (begtime < endtime) {
        ...
        Fsa::Weight score =
            Fsa::bestscore(
                Fsa::staticCopy(
                    allophoneStateGraphBuilder_->build(
                        *alignment,
                        Bliss::Coarticulated<Bliss::Pronunciation>(
                            *coarticulatedPronunciation.object().pronunciation(),
                            coarticulatedPronunciation.leftContext(),
    ...
    Precursor(c)
{
    if (initialize) {
        ...
        allophoneStateGraphBuilder_ =
            new AllophoneStateGraphBuilder(
...
Lattice::ConstWordLatticeRef TdpLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    alignmentGenerator_->setSpeechSegment(segment);
    TdpLatticeRescorerAutomaton *f =
        new TdpLatticeRescorerAutomaton(lattice, alignmentGenerator_,
                                        allophoneStateGraphBuilder_,
                                        acousticModel_);
    Lattice::WordLattice *result = new Lattice::WordLattice;
    result->setWordBoundaries(lattice->wordBoundaries());
...
Fsa::Weight CombinedAcousticLatticeRescorerAutomaton::_score(
    const Bliss::Coarticulated<Bliss::LemmaPronunciation> &coarticulatedPronunciation,
    TimeframeIndex begtime, TimeframeIndex endtime) const
{
 ...
 */
class CombinedAcousticSummedPronunciationLatticeRescorerAutomaton :
    public CombinedAcousticLatticeRescorerAutomaton
{
...
Fsa::Weight CombinedAcousticSummedPronunciationLatticeRescorerAutomaton::score(
    Fsa::StateId s, const Fsa::Arc &a) const
{
    ...
    if (pronunciation && begtime != InvalidTimeframeIndex) {
        ...
        for (Core::tie(p, p_end) = pronunciation->lemma()->pronunciations(); p != p_end; ++ p) {
            Bliss::Coarticulated<Bliss::LemmaPronunciation> coarticulatedPronunciation(
                *p, wordBoundaries_->transit(s).final,
                wordBoundaries_->transit(fsa_->getState(a.target())->id()).initial);

            resultScore = fsa_->semiring()->collect(
                Precursor::_score(coarticulatedPronunciation, begtime, endtime), resultScore);
        }
    }
    return resultScore;
}
...
CombinedAcousticLatticeRescorer::CombinedAcousticLatticeRescorer(
    const Core::Configuration &c)
    :
    Precursor(c),
    ...
    shouldSumOverPronunciations_(paramShouldSumOverPronunciations(config))
{
    ...
    modelCombination.load();
    allophoneStateGraphBuilder_ =
        new AllophoneStateGraphBuilder(config, modelCombination.lexicon(),
                                       modelCombination.acousticModel());
    std::vector <std::string> silencesAndNoises = paramSilencesAndNoises(config);
    allophoneStateGraphBuilder_->setSilencesAndNoises(silencesAndNoises);
    acousticModel_ = modelCombination.acousticModel();
...
{
    ModelCombination modelCombination(
        select("model-combination"), ModelCombination::useLexicon);
    modelCombination.load();
    allophoneStateGraphBuilder_ =
        new AllophoneStateGraphBuilder(
...
#if 0
Lattice::ConstWordLatticeRef CombinedAcousticLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    alignmentGenerator_->setSpeechSegment(segment);
    Fsa::ConstAutomatonRef em = Fsa::ConstAutomatonRef(
        new EmissionLatticeRescorerAutomaton(
            lattice, alignmentGenerator_,
            segmentwiseFeatureExtractor_->features(portId_), acousticModel_));
    Fsa::ConstAutomatonRef tdp = Fsa::ConstAutomatonRef(
        new TdpLatticeRescorerAutomaton(lattice, alignmentGenerator_,
                                        allophoneStateGraphBuilder_,
                                        acousticModel_));
    Lattice::WordLattice *result = new Lattice::WordLattice;
    result->setWordBoundaries(lattice->wordBoundaries());
    result->setFsa(Fsa::extend(em, tdp), Lattice::WordLattice::acousticFsa);
    return Lattice::ConstWordLatticeRef(result);
}
#endif
    ...
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    ...
    ConstSegmentwiseFeaturesRef features =
        ...
        segmentwiseFeatureExtractor_->features(portId_) :
    ...
    if (!shouldSumOverPronunciations_) {
        ...
        acoustic = Fsa::ConstAutomatonRef(
            new CombinedAcousticSummedPronunciationLatticeRescorerAutomaton(
                lattice, alignmentGenerator_, acousticModel_,
                features, allophoneStateGraphBuilder_));
    }
    Lattice::WordLattice *result = new Lattice::WordLattice;
 ...
 */
PronunciationLatticeRescorer::PronunciationLatticeRescorer(
    const Core::Configuration &c)
    :
    Precursor(c)
{
...
Lattice::ConstWordLatticeRef PronunciationLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *)
{
    PronunciationLatticeRescorerAutomaton *f = new PronunciationLatticeRescorerAutomaton(
        lattice, pronunciationScale_);
    Lattice::WordLattice *result = new Lattice::WordLattice;
...
private:
    ...
    struct ContextEquality
    {
        bool operator() (const Context &lhs, const Context &rhs) const {
            return lhs.begtim == rhs.begtim
                && lhs.endtim == rhs.endtim
                && lhs.label == rhs.label
    ...
    public:
        SetScoresDfsState(Lattice::ConstWordLatticeRef lattice,
                          Scores &scores, ConstLanguageModelRef languageModel) :
            Precursor(lattice),
...
private:
    ...
    Scores scores_;
public:
    RestoreScoresLatticeRescorerAutomaton(
        Lattice::ConstWordLatticeRef lattice, Lattice::ConstWordLatticeRef latticeWithScores,
...
RestoreScoresLatticeRescorer::RestoreScoresLatticeRescorer(
...
Lattice::ConstWordLatticeRef RestoreScoresLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    ...
    if (latticeWithScores && latticeWithScores->nParts() == 1) {
        RestoreScoresLatticeRescorerAutomaton *f =
            new RestoreScoresLatticeRescorerAutomaton(
                lattice, latticeWithScores, languageModel_);
        Lattice::WordLattice *result = new Lattice::WordLattice;
        result->setWordBoundaries(lattice->wordBoundaries());
        result->setFsa(Fsa::ConstAutomatonRef(f), Lattice::WordLattice::acousticFsa);
        return Lattice::ConstWordLatticeRef(result);
...
OrthographyApproximatePhoneAccuracyMaskLatticeRescorer::OrthographyApproximatePhoneAccuracyMaskLatticeRescorer(
    ...
    builder_(0)
{
    builder_ = new OrthographyApproximatePhoneAccuracyMaskLatticeBuilder(
...
Fsa::ConstAutomatonRef OrthographyApproximatePhoneAccuracyMaskLatticeRescorer::getDistanceFsa(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    verify(builder_);
    alignmentGenerator_->setSpeechSegment(segment);
...
ArchiveFrameStateAccuracyLatticeRescorer::ArchiveFrameStateAccuracyLatticeRescorer(
    ...
    builder_(0)
{
    builder_ = new ArchiveFrameStateAccuracyLatticeBuilder(
        select("frame-state-accuracy-lattice-builder"), lexicon);
}
...
Fsa::ConstAutomatonRef ArchiveFrameStateAccuracyLatticeRescorer::getDistanceFsa(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    verify(builder_);
    alignmentGenerator_->setSpeechSegment(segment);
...
OrthographyFrameStateAccuracyLatticeRescorer::OrthographyFrameStateAccuracyLatticeRescorer(
    ...
    builder_(0)
{
    builder_ = new OrthographyFrameStateAccuracyLatticeBuilder(
        select("frame-state-accuracy-lattice-builder"), lexicon);
}
...
Fsa::ConstAutomatonRef OrthographyFrameStateAccuracyLatticeRescorer::getDistanceFsa(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    verify(builder_);
    alignmentGenerator_->setSpeechSegment(segment);
...
OrthographySmoothedFrameStateAccuracyLatticeRescorer::OrthographySmoothedFrameStateAccuracyLatticeRescorer(
    ...
    builder_(0)
{
    builder_ = new OrthographySmoothedFrameStateAccuracyLatticeBuilder(
        select("smoothed-frame-state-accuracy-lattice-builder"), lexicon);
}
 ...
 */
Fsa::ConstAutomatonRef OrthographySmoothedFrameStateAccuracyLatticeRescorer::getDistanceFsa(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    verify(builder_);
    alignmentGenerator_->setSpeechSegment(segment);
...
Lattice::ConstWordLatticeRef WordAccuracyLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
...
PhonemeAccuracyLatticeRescorer::PhonemeAccuracyLatticeRescorer(
    ...
    orthToLemma_(0)
{
    lemmaPronToPhoneme_ = Fsa::cache(
        Fsa::invert(
            Fsa::replaceInputDisambiguationSymbols(
                lexicon->createPhonemeToLemmaPronunciationTransducer(),
                Fsa::Epsilon)));

    lemmaToPhoneme_ = Fsa::cache(
...
Lattice::ConstWordLatticeRef PhonemeAccuracyLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
...
LevenshteinListRescorer::LevenshteinListRescorer(
    ...
    builder_(0)
{
    builder_ = new LevenshteinNBestListBuilder(
        select("levenshtein-distance-list-builder"), lexicon);
}
...
Lattice::ConstWordLatticeRef LevenshteinListRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    verify(builder_);
    Lattice::WordLattice *result = new Lattice::WordLattice;
    result->setWordBoundaries(lattice->wordBoundaries());
    result->setFsa(
        builder_->createFunctor(
            segment->fullName(), segment->orth(), lattice->part(0)).build(),
...
OrthographyFrameWordAccuracyLatticeRescorer::OrthographyFrameWordAccuracyLatticeRescorer(
    ...
    builder_(0)
{
    builder_ = new OrthographyFrameWordAccuracyLatticeBuilder(
        select("frame-word-accuracy-lattice-builder"), lexicon);
}
...
OrthographyFramePhoneAccuracyLatticeRescorer::OrthographyFramePhoneAccuracyLatticeRescorer(
    ...
    builder_(0)
{
    builder_ = new OrthographyFramePhoneAccuracyLatticeBuilder(
        select("frame-phone-accuracy-lattice-builder"), lexicon);
}
...
Fsa::ConstAutomatonRef OrthographyFramePhoneAccuracyLatticeRescorer::getDistanceFsa(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    verify(builder_);
    alignmentGenerator_->setSpeechSegment(segment);
...
Lattice::ConstWordLatticeRef PosteriorLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    Fsa::Weight totalInv;
    Fsa::ConstAutomatonRef fsa =
        Fsa::posterior64(
            Fsa::changeSemiring(
                lattice->part(Lattice::WordLattice::totalFsa),
                Fsa::LogSemiring),
            totalInv,
            tolerance_);
...
LatticeRescorer* PosteriorLatticeRescorer::createPosteriorLatticeRescorer(
...
Lattice::ConstWordLatticeRef ExpectationPosteriorLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    ...
    archiveToCombine_(0)
{
    ...
    archiveToCombine_ = Lattice::Archive::openForReading(
        select("lattice-archive-to-combine"), lexicon);
...
Lattice::ConstWordLatticeRef CombinedPosteriorLatticeRescorer::work(
    Lattice::ConstWordLatticeRef lattice, Bliss::SpeechSegment *segment)
{
    ...
    Lattice::ConstWordLatticeRef toCombine =
        archiveToCombine_->get(
            segment->fullName(),
            part);

    Fsa::ConstAutomatonRef united =
        Fsa::unite(
            lattice->part(part),
            toCombine->part(part));
    ...
    fsa =
        Fsa::posterior64(
            ...
            totalInv,
            tolerance_);
    Fsa::Weight combinedTotalInv =
        fsa->semiring()->extend(
            totalInvToCombine,
            fsa->semiring()->invert(totalInv));
    ...
    recognizer_(0)
{
    ...
    ModelCombination modelCombination(
        select("model-combination"), lexicon, acousticModel, languageModel);
    modelCombination.load();
...
Lattice::ConstWordLatticeRef RecognizerWithConstrainedLanguageModel::extract(
    Lattice::ConstWordLatticeRef lattice,
