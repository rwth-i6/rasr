...
// ============================================================================
void mapHmmStates(PropertyMap::StringList&              keys,
...
void mapBoundaries(PropertyMap::StringList&              keys,
                   PropertyMap::ListOfIndexedStringList& values) {
...
void mapContext(PropertyMap::StringList&              keys,
                PropertyMap::ListOfIndexedStringList& values,
...
void mapConditions(PropertyMap::StringList&              keys,
                   PropertyMap::ListOfIndexedStringList& values,
...
void PropertyMap::set(const StringList&              keys,
    ...
    verify(*it == "boundary");
    ++it;
    for (historySize_ = 0; (it != keys.end()) && (it->find("history") == 0); ++it, ++historySize_)
        ;
    verify(it != keys.end());
    verify(*it == "central");
    ++it;
    for (futureSize_ = 0; (it != keys.end()) && (it->find("future") == 0); ++it, ++futureSize_)
        ;
...
// ============================================================================
void logKey(Core::XmlWriter&   xml,
...
void PropertyMapDiff::logDiff(Core::XmlWriter&   xml,
                              PropertyMap::Index l,
                              PropertyMap::Index r) {
...
PropertyMapDiff::PropertyMapDiff(const Core::Configuration& config,
...
// ============================================================================
class XmlDecisionTreeParser : public Cart::XmlDecisionTreeParser {
protected:
