...
#ifdef __APPLE__
    template<> inline bool isnan<float>(float val) { return std::isnan(val); }
    template<> inline bool isnan<double>(double val) { return std::isnan(val); }
    template<> inline bool isnan<long double>(long double val) { return std::isnan(val); }
#else
...
#ifdef __APPLE__
    template<> inline bool isinf<float>(float val) { return std::isinf(val); }
    template<> inline bool isinf<double>(double val) { return std::isinf(val); }
    template<> inline bool isinf<long double>(long double val) { return std::isinf(val); }
#else
    template<> inline bool isinf<float>      (float val)       { return __isinf(val); }
    template<> inline bool isinf<double>     (double val)      { return __isinf(val); }
    template<> inline bool isinf<long double>(long double val) { return __isinf(val); }
#endif
