...
public:
     ...
     */
    SizeType voluntaryContextSwitches() const {
        return nvcsw_;
    }
    /**
     ...
     * time slice.
     */
    SizeType involuntaryContextSwitches() const {
        return nicsw_;
    }
