...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-map-alphabet";
    }
};
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-gamma-correction";
    }
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-combine-items";
    }
};
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-clip-weights";
    }
    virtual bool setParameter(const std::string& name, const std::string& value);
};
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-reset-weights";
    }
    virtual bool setParameter(const std::string& name, const std::string& value);
};
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-multiply-alignments";
    }
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-multiply-weights";
    }
    virtual bool setParameter(const std::string& name, const std::string& value);
};
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-add-weight";
    }
    virtual bool setParameter(const std::string& name, const std::string& value);
};
...
public:
    ...
    static std::string filterName() {
        return "speech-alignment-remove-emission-score";
    }
    virtual Flow::PortId getInput(const std::string& name) {
...
public:
    static std::string filterName() {
        return "alignment-weights-by-tied-state-alignment-weights";
    }
