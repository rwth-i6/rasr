...
namespace Ftl {
    ...
    template<class _Automaton> class AllPrefixesAutomaton : public ModifyAutomaton<_Automaton> {
    typedef ModifyAutomaton<_Automaton> Precursor;
    public:
        typedef typename _Automaton::State _State;
        typedef typename _Automaton::ConstStateRef _ConstStateRef;
        ...
        AllPrefixesAutomaton(_ConstAutomatonRef f) : Precursor(f) {
    ...
    private:
        ...
        public:
            ...
            ProductiveStateFinder(_ConstAutomatonRef f, std::vector<bool>& productive_states) : Precursor(f), productiveStates_(productive_states) {}
    ...
    template<class _Automaton> typename _Automaton::ConstRef allPrefixes(
        typename _Automaton::ConstRef f) {
        return ref(new AllPrefixesAutomaton<_Automaton>(f));
    }

    // add an edge from the start-state to all productive states
    template<class _Automaton> class AllSuffixesAutomaton : public ModifyAutomaton<_Automaton> {
    typedef ModifyAutomaton<_Automaton> Precursor;
    public:
        typedef typename _Automaton::State _State;
        typedef typename _Automaton::ConstStateRef _ConstStateRef;
        ...
        AllSuffixesAutomaton(_ConstAutomatonRef f) : Precursor(f) {
    ...
    private:
        ...
        public:
            ...
            ReachableStateFinder(_ConstAutomatonRef f, std::vector<bool>& reachable_states) : Precursor(f), reachableStates_(reachable_states) {}
    ...
    template<class _Automaton> typename _Automaton::ConstRef allSuffixes(
        typename _Automaton::ConstRef f) {
