 ...
 * </properties-definition>
 */
class PropertyMap : public Core::ReferenceCounted {
public:
...
public:
    ...
    PropertyMap(const StringList&              keys,
...
class PropertyMapDiff : public Core::Component {
private:
    /**
...
private:
    ...
    void logUniq(Core::XmlWriter& xml,
                 std::string      key,
                 u16              diff);
 ...
 */
class StoredProperties : public Properties {
public:
    typedef std::vector<std::string> StringList;
...
public:
    ...
    StoredProperties(PropertyMapRef    map,
