 ...
 *  LatticeSetExtractor
 */
class LatticeSetExtractor : public virtual Core::Component {
 ...
 *  LatticeSetGenerator
 */
class LatticeSetGenerator : public LatticeSetProcessor,
...
public:
    ...
    virtual bool hasNnEmissionRescorer() const {
        return paramNnEmissionExtractors(config).size() > 0;
    }
 ...
 *  LatticeSetReader
 */
class LatticeSetReader : public LatticeSetProcessorRoot,
                         public LatticeSetExtractor {
 ...
 *  LatticeSetWriter
 */
class LatticeSetWriter : public LatticeSetProcessor {
    typedef LatticeSetProcessor Precursor;
