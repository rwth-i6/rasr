 ...
 */
class StatePosteriorFeatureScorer :
public CachedAssigningFeatureScorer
{
...
struct IndexAndWeight {
    MixtureIndex e;
    Weight w; // -log(x)
    IndexAndWeight(MixtureIndex _e, Weight _w) : e(_e), w(_w) {}
};
...
public:
    ...
    Weight minimumScore() const { return minimumScore_; }
    DensityIndex minimumIndex() const { return minimumIndex_;}
