...
public:
     ...
     */
    f64 outputSampleRate() const {
        return length_ / sampleRate_;
    }
...
public:
    static std::string name() {
        return "complex-fast-fourier-transform";
    }
    ...
    virtual u32 maximalInputSize() const {
        return 2 * length();
    }
    virtual void setInputSize(u32 inputSize) {
        setLength(inputSize / 2);
    }
    virtual u32 outputSize() const {
        return 2 * length();
    }
};
...
public:
    static std::string name() {
        return "complex-inverse-fast-fourier-transform";
    }
...
public:
    static std::string name() {
        return "real-fast-fourier-transform";
    }
...
public:
    static std::string name() {
        return "real-inverse-fast-fourier-transform";
    }
