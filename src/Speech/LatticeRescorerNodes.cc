 ...
 */
DistanceLatticeRescorerNode::DistanceLatticeRescorerNode(
    const Core::Configuration &c) :
    Core::Component(c),
    Precursor(c)
{}
 ...
 */
ApproximateDistanceLatticeRescorerNode::ApproximateDistanceLatticeRescorerNode(
    const Core::Configuration &c) :
    Core::Component(c),
    Precursor(c)
{
    ...
    Lattice::ConstWordLatticeRef ref, Lattice::ConstWordLatticeRef hyp)
{
    ...
    return builder_->createFunctor(
        segmentId(), ref, hyp, alignmentGenerator_).build();
}
...
void FramePhoneAccuracyLatticeRescorerNode::initialize(ModelCombinationRef modelCombination)
{
    Precursor::initialize(modelCombination);
    verify(!builder_);
    builder_ = new FramePhoneAccuracyLatticeBuilder(
        select("frame-phone-accuracy-lattice-builder"), modelCombination->lexicon());
    needInit_ = false;
}
...
void SoftFramePhoneAccuracyLatticeRescorerNode::initialize(ModelCombinationRef modelCombination)
{
    Precursor::initialize(modelCombination);
    verify(!builder_);
    builder_ = new SoftFramePhoneAccuracyLatticeBuilder(
        select("soft-frame-phone-accuracy-lattice-builder"), modelCombination->lexicon());
    needInit_ = false;
}

Fsa::ConstAutomatonRef SoftFramePhoneAccuracyLatticeRescorerNode::getDistanceFsa(
    Lattice::ConstWordLatticeRef ref, Lattice::ConstWordLatticeRef hyp)
{
...
Fsa::ConstAutomatonRef SoftFramePhoneAccuracyLatticeRescorerNode::getDistanceFsa(
    const Alignment *ref, Lattice::ConstWordLatticeRef hyp)
{
    verify(builder_);
    return builder_->createFunctor(
        segmentId(), ref, hyp, alignmentGenerator_).build();
...
void WeightedFramePhoneAccuracyLatticeRescorerNode::initialize(ModelCombinationRef modelCombination)
{
    Precursor::initialize(modelCombination);
    verify(!builder_);
    builder_ = new WeightedFramePhoneAccuracyLatticeBuilder(
        select("weighted-frame-phone-accuracy-lattice-builder"), modelCombination->lexicon());
    needInit_ = false;
}

Fsa::ConstAutomatonRef WeightedFramePhoneAccuracyLatticeRescorerNode::getDistanceFsa(
    Lattice::ConstWordLatticeRef ref, Lattice::ConstWordLatticeRef hyp)
{
    verify(builder_);
    return builder_->createFunctor(
...
AcousticLatticeRescorerNode::AcousticLatticeRescorerNode(
    const Core::Configuration &c) :
    Core::Component(c),
    Precursor(c),
...
Fsa::ConstAutomatonRef AcousticLatticeRescorerNode::getRescoredFsa(
    Lattice::ConstWordLatticeRef lattice)
{
    Fsa::ConstAutomatonRef fsa;
    switch(rescoreMode_){
    case rescoreModeAlignment:
        fsa = Fsa::ConstAutomatonRef(
    ...
    case rescoreModeTdp:
        fsa = Fsa::ConstAutomatonRef(
            new TdpLatticeRescorerAutomaton(
                lattice, alignmentGenerator_,
