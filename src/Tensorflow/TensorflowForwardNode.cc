...
//bool TensorflowForwardNode::configure() {
//}
...
Tensor TensorflowForwardNode::toTensor(std::vector<Flow::DataPtr<Flow::Timestamp>> const& data) const {
...
template<typename T>
Tensor TensorflowForwardNode::vectorToTensor(std::vector<Flow::DataPtr<Flow::Timestamp>> const& data) const {
...
void TensorflowForwardNode::appendToOutput(Tensor const& tensor, size_t start_frame, std::vector<Flow::Data*>& data) const {
    ...
    if (dt_name == "DT_FLOAT") {
        appendVectorsToOutput<f32>(tensor, start_frame, data);
    }
    else if (dt_name == "DT_DOUBLE") {
        appendVectorsToOutput<f64>(tensor, start_frame, data);
    }
    else if (dt_name == "DT_INT64") {
        appendVectorsToOutput<s64>(tensor, start_frame, data);
    }
    else if (dt_name == "DT_UINT64") {
        appendVectorsToOutput<u64>(tensor, start_frame, data);
    }
    else if (dt_name == "DT_INT32") {
        appendVectorsToOutput<s32>(tensor, start_frame, data);
    }
    else if (dt_name == "DT_UINT32") {
        appendVectorsToOutput<u32>(tensor, start_frame, data);
    }
    else {
...
template<typename T>
void TensorflowForwardNode::appendVectorsToOutput(Tensor const& tensor, size_t start_frame, std::vector<Flow::Data*>& data) const {
