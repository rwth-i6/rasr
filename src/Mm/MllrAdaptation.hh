...
namespace Mm {
    ...
    public:
        ...
        //virtual void adaptMixtureSet(Core::Ref<Mm::AbstractMixtureSet> adaptableMixtureSet, Core::Ref<Mm::Adaptor>) const = 0;
    ...
    protected:
        ...
        template <class T>
        void propagate(const Math::Vector<T>& leafData, Math::Vector<T> &nodeData, NodeId id);
    ...
    template <class T>
    void AdaptorEstimator::propagate(const Math::Vector<T>& leafData,
                                      Math::Vector<T> &nodeData, NodeId id)
    {
...
#if 0
    Core::BinaryOutputStream& operator<< (Core::BinaryOutputStream& o, const FullAdaptorViterbiEstimator &a);
    Core::BinaryInputStream& operator>> (Core::BinaryInputStream& i, FullAdaptorViterbiEstimator &a);
    Core::BinaryOutputStream& operator<< (Core::BinaryOutputStream& o, const FullAdaptor &a);
    Core::BinaryInputStream& operator>> (Core::BinaryInputStream& i, FullAdaptor &a);
#endif
