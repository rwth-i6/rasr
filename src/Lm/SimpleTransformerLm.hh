...
struct SimpleScoreHistory : public SimpleHistory {  // tokSeq and refCount in base
    std::vector<Score> scores;
    size_t             cacheHash;

    typedef SimpleHistory Precursor;
    SimpleScoreHistory(Bliss::Token::Id tid)
            : Precursor(tid), cacheHash(0) {}
...
public:
    ...
    const SimpleHistoryCache& getCache() const {
