...
namespace Speech {
    ...
    class LemmaPronunciationToEvaluationToken :
        public TokenMappingLatticeProcessorNode
    {
    ...
    class LemmaPronunciationToSyntacticToken :
        public TokenMappingLatticeProcessorNode
    {
        typedef TokenMappingLatticeProcessorNode Precursor;
    protected:
    ...
    class MinimumMaximumWeightNode :
        public LatticeSetProcessor
    {
        typedef LatticeSetProcessor Precursor;
    private:
