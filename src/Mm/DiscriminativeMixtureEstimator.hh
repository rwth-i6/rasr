 ...
 */
class DiscriminativeMixtureEstimator : public AbstractMixtureEstimator {
...
public:
     ...
     */
    virtual void removeDensitiesWithLowWeight(Weight minObservationWeight, Weight minRelativeWeight = 0);
