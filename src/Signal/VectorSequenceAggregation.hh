...
template<class T>
class VectorSequenceAggregation : public DelayNode {
...
template<class T>
bool VectorSequenceAggregation<T>::setParameter(const std::string& name, const std::string& value) {
...
bool VectorSequenceAggregation<T>::configure() {
    ...
    auto                                    attr = std::make_shared<Flow::Attributes>();
...
template<class T>
bool VectorSequenceAggregation<T>::putData() {
