...
public:
    CloningStateRescorer(const RescoreLattice* l)
            : Precursor(l) {}
...
public:
    CachingInPlaceStateRescorer(const RescoreLattice* l)
            : Precursor(l) {}
    virtual ConstStateRef operator()(Fsa::StateId sid) const {
        cache_.grow(sid);
...
public:
    InPlaceStateRescorer(const RescoreLattice* l)
            : Precursor(l) {}
    virtual ConstStateRef operator()(Fsa::StateId sid) const {
...
RescoreLattice::RescoreLattice(ConstLatticeRef l, RescoreMode rescoreMode)
        : Precursor(l) {
    switch (rescoreMode) {
