...
Trace::Trace( const Core::Ref<Trace>& pre, const Bliss::LemmaPronunciation* p, SearchAlgorithm::TimeframeIndex t, SearchAlgorithm::ScoreVector s, const Search::SearchAlgorithm::TracebackItem::Transit& transit ) :
