...
Core::Ref<MixtureSet> Module_::readMixtureSet(const std::string& filename, const Core::Configuration& configuration) const {
    Core::Ref<MixtureSet> result;
    if (filename.empty()) {
        return result;
    }
...
Core::Ref<AbstractMixtureSet> Module_::readAbstractMixtureSet(const std::string& filename, const Core::Configuration& configuration) const {
...
Core::Ref<AbstractMixtureSet> Module_::readAbstractMixtureSet(const Core::Configuration& configuration) const {
...
AbstractMixtureSetEstimator* Module_::createMixtureSetEstimator(const Core::Configuration& configuration) const {
...
AbstractMixtureSetEstimator* Module_::createMixtureSetEstimator(const Core::Configuration& configuration,
                                                                size_t                     nMixtures,
                                                                size_t                     dimension,
                                                                size_t                     nDensitiesPerMixture) const {
    AbstractMixtureSetEstimator* result     = 0;
    Core::Ref<MixtureSet>        mixtureSet = createMixtureSet(configuration, nMixtures, dimension, nDensitiesPerMixture);
    if (mixtureSet) {
...
bool Module_::writeMixtureSetEstimator(const std::string& filename, AbstractMixtureSetEstimator& estimator) {
...
Core::Ref<FeatureScorer> Module_::createFeatureScorer(const Core::Configuration&                c,
                                                      const Core::Ref<const AbstractMixtureSet> m) const {
    FeatureScorer* result = featureScorerFactory_->createFeatureScorer(static_cast<FeatureScorerType>(paramFeatureScorerType(c)), c, m);
    if (!result) {
...
Core::Ref<AssigningFeatureScorer> Module_::createAssigningFeatureScorer(const Core::Configuration&                c,
                                                                        const Core::Ref<const AbstractMixtureSet> m) const {
    Core::Ref<AssigningFeatureScorer> result(dynamic_cast<AssigningFeatureScorer*>(createFeatureScorer(c, m).get()));
...
Core::Ref<ScaledFeatureScorer> Module_::createScaledFeatureScorer(const Core::Configuration& c, Core::Ref<FeatureScorer> featureScorer) const {
    return featureScorer ? Core::Ref<ScaledFeatureScorer>(new FeatureScorerScaling(c, featureScorer)) : Core::Ref<ScaledFeatureScorer>();
}
