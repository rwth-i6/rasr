 ...
 **/
void minEntropyWeights(WeightsList& weightsList, const ConstPosteriorCnRefList& cns, const ScoreList& _weights) {
...
void inverseEntropyWeights(WeightsList& weightsList, const ConstPosteriorCnRefList& cns, const ScoreList& _weights) {
    const std::vector<f64> weights(_weights.begin(), _weights.end());
...
void estimateJointPosteriorCn(PosteriorCn& jointCn, const ConstPosteriorCnRefList& cns, const WeightsList& weightsList) {
...
void estimateMaxPosteriorCn(PosteriorCn& maxCn, const ConstPosteriorCnRefList& cns, const WeightsList& weightsList) {
