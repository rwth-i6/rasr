...
public:
    ...
    AbstractParameter(const char* ident,
                      const char  abbrev,
                      const char* short_desc,
                      const char* long_desc,
 ...
 */
template<class T>
class AbstractChoiceParameter : public Parameter<T> {
public:
    typedef T Value;
    ...
    AbstractChoiceParameter(const char*          ident,
                            const char*          s_desc,
...
public:
    ...
    RangedParameter(const char*  ident,
                    const char*  s_desc,
                    const Value& defaultValue,
 ...
 */
class ParameterBool : public AbstractChoiceParameter<bool> {
public:
    virtual const Choice& choice() const {
        return boolChoice;
    };
    ParameterBool(const char* ident,
                  const char* s_desc,
 ...
 */
class ParameterInt : public RangedParameter<s32> {
public:
    virtual void printParseHelp(std::ostream& os) const;
    virtual bool parseString(const std::string& in, Value& out) const;
    ParameterInt(const char* ident,
                 const char* s_desc,
                 s32         defaultValue = 0,
 ...
 */
class ParameterFloat : public RangedParameter<f64> {
public:
    virtual void printParseHelp(std::ostream& os) const;
    virtual bool parseString(const std::string& in, Value& out) const;
    ParameterFloat(const char* ident,
                   const char* s_desc,
 ...
 */
class ParameterChoice : public AbstractChoiceParameter<s32> {
private:
...
public:
    ...
    ParameterChoice(const char*   ident,
                    const Choice* c,
                    const char*   s_desc,
 ...
 */
class ParameterString : public Parameter<std::string> {
public:
    virtual bool parseString(const std::string& in, Value& out) const;
    ParameterString(const char* ident,
                    const char* s_desc,
 ...
 */
class ParameterBitVector : public Parameter<std::vector<bool>> {
public:
    ...
    ParameterBitVector(const char*  ident,
                       const char*  s_desc,
 ...
 */
template<class T>
class VectorParameter : public AbstractParameter {
public:
    typedef T              Value;
    typedef u32            Size;
...
public:
    ...
    VectorParameter(const char*       ident,
                    const char*       s_desc,
     ...
     * Just string conversion, no Configuration involved.
     */
    Vector operator()(const std::string& str) const {
 ...
 */
class ParameterStringVector : public VectorParameter<std::string> {
protected:
    virtual bool parseString(const std::string& in, Vector& out) const;

public:
    ParameterStringVector(const char*       ident,
                          const char*       s_desc,
                          const std::string delimiter = "",
                          const Size        minSize   = Core::Type<Size>::min,
                          const Size        maxSize   = Core::Type<Size>::max,
 ...
 */
class ParameterIntVector : public VectorParameter<s32> {
protected:
    virtual bool parseString(const std::string& in, Vector& out) const;

public:
    ParameterIntVector(const char*       ident,
                       const char*       s_desc,
                       const std::string delimiter = "",
 ...
 */
class ParameterFloatVector : public VectorParameter<f64> {
protected:
    virtual bool parseString(const std::string& in, Vector& out) const;

public:
    ParameterFloatVector(const char*       ident,
                         const char*       s_desc,
                         const std::string delimiter = "",
 ...
 */
class ParameterWeightVector : public VectorParameter<f64> {
protected:
    virtual bool parseString(const std::string& in, Vector& out) const;
...
public:
    ParameterWeightVector(const char*       ident,
                          const char*       s_desc,
                          const std::string delimiter       = "",
