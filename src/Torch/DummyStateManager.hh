...
#ifndef _TORCH_DUMMYSTATEMANAGER_HH
#define _TORCH_DUMMYSTATEMANAGER_HH
...
/*
 * No-op state manager for models without explicit runtime state tensors
 */
...
#endif  // _TORCH_DUMMYSTATEMANAGER_HH