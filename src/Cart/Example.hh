...
public:
    ...
    public:
        ...
        const_row_iterator operator*() const {
            return ptr_;
        }
        void operator++() {
            ptr_ += size_;
        ...
        bool operator!=(const row_vector_iterator& it) const {
            return ptr_ != it.ptr_;
        }
    };
    ...
    public:
        ...
        bool operator!=(const const_row_vector_iterator& it) const {
            return ptr_ != it.ptr_;
        }
    };
    ...
    public:
        ...
        column_iterator end() {
            return column_iterator(ptr_ + overall_size_, 0);
        }
        ...
        const_column_iterator end() const {
            return const_column_iterator(ptr_ + overall_size_, 0);
        }

        column_iterator operator*() {
            return column_iterator(ptr_, size_);
        }
        const_column_iterator operator*() const {
            return const_column_iterator(ptr_, size_);
        }
        void operator++() {
            ++ptr_;
        ...
        bool operator!=(const column_vector_iterator& it) const {
            return ptr_ != it.ptr_;
        }
    };
    ...
    public:
        ...
        bool operator!=(const const_column_vector_iterator& it) const {
            return ptr_ != it.ptr_;
        }
    };
...
public:
    ...
    f64 get(size_t i) const {
        return begin_[i];
    }
    void set(size_t i, f64 value) {
        begin_[i] = value;
    }

    f64& operator()(size_t i) {
        return begin_[i];
    }
    ...
    f64 get(size_t i, size_t j) const {
        return begin_[i * columns_ + j];
    }
    void set(size_t i, size_t j, f64 value) {
        begin_[i * columns_ + j] = value;
    }
 ...
 * of examples.
 */
class Example : public Core::ReferenceCounted {
public:
...
class ExampleList : Core::Component {
protected:
...
public:
    ...
    static const Core::ParameterString       paramExampleFileEncoding;
...
public:
    ExampleList(const Core::Configuration& config,
    ...
    void add(ExampleRef exampleRef) {
        exampleRefs_.push_back(exampleRef);
    }
    void set(size_t id, Example* example) {
        set(id, ExampleRef(example));
    }
    void set(size_t id, ExampleRef exampleRef) {
        exampleRefs_.set(id, exampleRef);
    }

    size_t size() const {
        return exampleRefs_.size();
    }
    ExampleRef operator[](size_t i) {
        return exampleRefs_[i];
    }
    iterator begin() {
        return exampleRefs_.begin();
    }
    iterator end() {
        return exampleRefs_.end();
    }
    ConstExampleRef operator[](size_t i) const {
        return exampleRefs_[i];
    }
