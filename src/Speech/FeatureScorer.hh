...
public:
    ...
    public:
        ...
        f64 weightedSum() const {
            return weightedSum_;
        }
        f64 sumOfWeights() const {
            return sumOfWeights_;
        }
        f64 weightedAverage() const {
...
public:
    ...
    const CorpusKeyToScoreMap& scores() const {
        return corpusKeyToScoreMap_;
    }
    void reset() {
        corpusKeyToScoreMap_.clear();
    }
