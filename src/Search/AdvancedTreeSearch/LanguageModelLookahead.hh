...
// state-id or node-index
//     Score score( u32 s ) const {
//       return scoreForLookAheadId( la_->lookaheadId( s ) );
//     }
//
//     inline Score scoreForLookAheadId( LookaheadId id ) const {
//       if( scores_.empty() )
//       {
//         return sparseScores_[ id ];
//       }else{
//         return scores_[ id ];
//       }
//     }

//     inline Score scoreForLookAheadHashSparse( u32 hash ) const {
//       return sparseScores_[ hash ];
//     }
...
public:
    LookAheadNodesForDepth() : size_( 0 ) {
...
//   mutable std::vector<u32> nodeObservations_;
