...
protected:
    ...
    enum FileType { TypeVector, TypeConst, TypeCompact, TypeNGram };
...
public:
    static std::string name() { return "read-fst"; }
};
...
protected:
    virtual AutomatonRef process();
public:
    static std::string name() { return "read-fsa"; }
};
...
public:
    static std::string name() { return "write-fst"; }
};
...
protected:
    virtual AutomatonRef process();
public:
    static std::string name() { return "write-fsa"; }
};
...
protected:
    virtual AutomatonRef process();
public:
    static std::string name() { return "compress"; }
};
